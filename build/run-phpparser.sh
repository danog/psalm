...
php -d memory_limit=3000M psalm -c psalm-transpile-phpparser.xml --no-cache --no-progress --threads=1 --scan-threads=1 --transpile-rust=rust/generated/php_parser > build/transpile.log 2>&1
