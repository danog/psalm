...
php -d memory_limit=5000M ../psalm-transpiler/psalm -c psalm-transpile-psalm-tests.xml --no-cache --no-progress --threads=1 --transpile-rust=rust/generated/psalm_base --transpile-rust-split=rust/generated/psalm_data:dictionaries --transpile-rust-split=rust/generated/psalm_src:src --transpile-rust-split=rust/generated/psalm_tests:tests --transpile-rust-data='dictionaries/*.php' > build/transpile-psalm-tests.log 2>&1
