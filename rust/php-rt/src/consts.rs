...
tokens! {
    ...
    T_ABSTRACT = 322, T_FINAL = 323, T_PRIVATE = 324, T_PROTECTED = 325, T_PUBLIC = 326, T_READONLY = 327,
    T_VAR = 328, T_UNSET = 329, T_ISSET = 330, T_EMPTY = 331, T_HALT_COMPILER = 332, T_CLASS = 333,
    T_TRAIT = 334, T_INTERFACE = 335, T_ENUM = 336, T_EXTENDS = 337, T_IMPLEMENTS = 338, T_NAMESPACE = 339,
    T_LIST = 340, T_ARRAY = 341, T_CALLABLE = 342, T_LINE = 343, T_FILE = 344, T_DIR = 345, T_CLASS_C = 346,
    T_TRAIT_C = 347, T_METHOD_C = 348, T_FUNC_C = 349, T_PROPERTY_C = 350, T_NS_C = 351, T_ATTRIBUTE = 352,
    T_PLUS_EQUAL = 353, T_MINUS_EQUAL = 354, T_MUL_EQUAL = 355, T_DIV_EQUAL = 356, T_CONCAT_EQUAL = 357,
    T_MOD_EQUAL = 358, T_AND_EQUAL = 359, T_OR_EQUAL = 360, T_XOR_EQUAL = 361, T_SL_EQUAL = 362, T_SR_EQUAL = 363,
    T_COALESCE_EQUAL = 364, T_POW_EQUAL = 365, T_PIPE = 366, T_COALESCE = 367, T_BOOLEAN_OR = 368,
    T_BOOLEAN_AND = 369, T_IS_EQUAL = 370, T_IS_NOT_EQUAL = 371, T_IS_IDENTICAL = 372, T_IS_NOT_IDENTICAL = 373,
    T_IS_SMALLER_OR_EQUAL = 374, T_IS_GREATER_OR_EQUAL = 375, T_SPACESHIP = 376, T_SL = 377, T_SR = 378,
    T_INC = 379, T_DEC = 380, T_INT_CAST = 381, T_DOUBLE_CAST = 382, T_STRING_CAST = 383, T_ARRAY_CAST = 384,
    T_OBJECT_CAST = 385, T_BOOL_CAST = 386, T_UNSET_CAST = 387, T_VOID_CAST = 388, T_OBJECT_OPERATOR = 389,
    T_NULLSAFE_OBJECT_OPERATOR = 390, T_DOUBLE_ARROW = 391, T_COMMENT = 392, T_DOC_COMMENT = 393,
    T_OPEN_TAG = 394, T_OPEN_TAG_WITH_ECHO = 395, T_CLOSE_TAG = 396, T_WHITESPACE = 397, T_START_HEREDOC = 398,
