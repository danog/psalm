...
impl Doc {
    ...
    pub fn jsonSerialize(&self) -> Result<Shape_filePos_Mixed_line_Mixed_nodeType_Str_text_Mixed, Throw> { cast::<crate::php_parser::Comment>(self.clone()).jsonSerialize__impl() }
