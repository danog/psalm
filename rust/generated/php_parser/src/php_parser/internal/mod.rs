...
impl DifferTest {
    ...
    { let _ = self; crate::phpunit::framework::Assert::assertEquals({ let __c1261 = (crate::php_parser::internal::DiffElem::new(crate::php_parser::internal::DiffElem::TYPE_KEEP(), cast::<Mixed>(Str::from_static("a")), cast::<Mixed>(Str::from_static("a")))?, crate::php_parser::internal::DiffElem::new(crate::php_parser::internal::DiffElem::TYPE_KEEP(), cast::<Mixed>(Str::from_static("b")), cast::<Mixed>(Str::from_static("b")))?); let mut __m: Map<ArrayKey, Mixed> = Map::new(); __m.push(cast::<Mixed>(__c1261.0)); __m.push(cast::<Mixed>(__c1261.1)); Mixed::Arr(__m) }, cast::<Mixed>(diff.clone()), Str::from_static(""))? };
    #[allow(unreachable_code)] Ok(())
    }
