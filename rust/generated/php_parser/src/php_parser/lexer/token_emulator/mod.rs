        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if ((((((({ let _ = Some(map_v.clone()); None::<Mixed> }.is_some()) && ((i).wrapping_add(3i64) < c)) && identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), &Str::from_static("("))) && (tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(2i64))).clone().p_id_get() == 262i64)) && identical(&strtolower(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(2i64))).clone().p_text_get()), &Str::from_static("set"))) && identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(3i64))).clone().p_text_get(), &Str::from_static(")"))) && self.isKeywordContext(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)), i)?) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(4i64); let __repl = { let __c18 = (crate::php_parser::Token::new({ let __c17 = map_v.clone(); let mut __m: Map<ArrayKey, i64> = Default::default(); __m.insert(ArrayKey::from(Str::from_static("324")), __c17.k324); __m.insert(ArrayKey::from(Str::from_static("325")), __c17.k325); __m.insert(ArrayKey::from(Str::from_static("326")), __c17.k326); __m }.idx(&to_key(&token.get().clone().p_id_get())).clone(), concat(concat(concat(token.get().clone().p_text_get(), Str::from_static("(")), tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(2i64))).clone().p_text_get()), Str::from_static(")")), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c18.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if ((identical(&token.get().clone().p_text_get(), &Str::from_static("#")) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone()).and_then(|__b| __b.get(&__k).cloned()) }.and_then(|__m| __m.to_option()).is_some())) && identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), &Str::from_static("["))) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c21 = (crate::php_parser::Token::new(355i64, Str::from_static("#["), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c21.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if (((((token.get().clone().p_id_get() == 260i64) && identical(&token.get().clone().p_text_get(), &Str::from_static("0"))) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone()).and_then(|__b| __b.get(&__k).cloned()) }.and_then(|__m| __m.to_option()).is_some())) && (tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_id_get() == 262i64)) && truthy(&preg_match(&Str::from_static("/[oO][0-7]+(?:_[0-7]+)*/"), &tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), 0)?)) {
                    ...
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c22 = (crate::php_parser::Token::new(tokenKind, concat(Str::from_static("0"), tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get()), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c22.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
                    let _ = { let __t1 = c; c = __t1.wrapping_sub(1); __t1 };
                }
            }
            let _ = { let __t2 = i; i = __t2.wrapping_add(1); __t2.wrapping_add(1) };
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if ((identical(&token.get().clone().p_text_get(), &Str::from_static("?")) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone()).and_then(|__b| __b.get(&__k).cloned()) }.and_then(|__m| __m.to_option()).is_some())) && (tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_id_get() == 389i64)) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c23 = (crate::php_parser::Token::new(390i64, Str::from_static("?->"), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c23.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
                    let _ = { let __t1 = c; c = __t1.wrapping_sub(1); __t1 };
                    { break 'c2 };
                }
    ...
    let mut token: Late<crate::php_parser::Token> = Late::uninit();
    {
        ...
        'l1: loop {
            ...
            'c2: {
                token.set(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&i)).clone());
                if ((identical(&token.get().clone().p_text_get(), &Str::from_static("|")) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone()).and_then(|__b| __b.get(&__k).cloned()) }.and_then(|__m| __m.to_option()).is_some())) && identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), &Str::from_static(">"))) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c24 = (crate::php_parser::Token::new(408i64, Str::from_static("|>"), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c24.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
                    let _ = { let __t1 = c; c = __t1.wrapping_sub(1); __t1 };
                }
            }
            let _ = { let __t2 = i; i = __t2.wrapping_add(1); __t2.wrapping_add(1) };
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if (token.get().clone().p_id_get() == 408i64) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(1i64); let __repl = { let __c25 = (crate::php_parser::Token::new(ord(&Str::from_static("|")), Str::from_static("|"), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?, crate::php_parser::Token::new(ord(&Str::from_static(">")), Str::from_static(">"), token.get().clone().p_line_get(), (token.get().clone().p_pos_get()).wrapping_add(1i64))?); List::from_vec(vec![cast::<Mixed>(__c25.0), cast::<Mixed>(__c25.1)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
    ...
    let mut k: i64 = Default::default();
    {
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                let _: List<Mixed> = { let __off = i; let __len = Some(numTokens); let __repl = { let __c26 = (crate::php_parser::Token::new(388i64, text.clone(), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c26.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
