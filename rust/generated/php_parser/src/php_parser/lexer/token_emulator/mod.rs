...
impl AsymmetricVisibilityTokenEmulator {
    ...
    let mut map_v: Shape_324_Int_325_Int_326_Int = Default::default();
    let mut i: i64 = Default::default();
    let mut c: i64 = Default::default();
    let mut token: Late<crate::php_parser::Token> = Late::uninit();
    map_v = Shape_324_Int_325_Int_326_Int { k326: 329i64, k325: 328i64, k324: 327i64 };
    {
        i = 0i64;
    ...
    let mut reverseMap: Shape_327_Int_328_Int_329_Int = Default::default();
    let mut i: i64 = Default::default();
    let mut c: i64 = Default::default();
    let mut token: Late<crate::php_parser::Token> = Late::uninit();
    ...
    reverseMap = Shape_327_Int_328_Int_329_Int { k329: 326i64, k328: 325i64, k327: 324i64 };
    {
        i = 0i64;
        c = tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).count();
        'l1: loop {
            ...
            'c2: {
                token.set(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&i)).clone());
                if (({ let _ = Some(reverseMap.clone()); None::<Mixed> }.is_some()) && truthy(&{ let (__r, __m) = preg_match_groups(&Str::from_static("/(public|protected|private)\\((set)\\)/i"), &token.get().clone().p_text_get(), 0)?; matches = __m; __r })) {
                    ...
                    let _: List<Mixed> = { let __off = i; let __len = Some(1i64); let __repl = { let __c21 = (crate::php_parser::Token::new({ let __c20 = reverseMap.clone(); let mut __m: Map<ArrayKey, i64> = Default::default(); __m.insert(ArrayKey::from(Str::from_static("327")), __c20.k327); __m.insert(ArrayKey::from(Str::from_static("328")), __c20.k328); __m.insert(ArrayKey::from(Str::from_static("329")), __c20.k329); __m }.idx(&to_key(&token.get().clone().p_id_get())).clone(), modifier.clone(), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?, crate::php_parser::Token::new(ord(&Str::from_static("(")), Str::from_static("("), token.get().clone().p_line_get(), (token.get().clone().p_pos_get()).wrapping_add(modifierLen))?, crate::php_parser::Token::new(262i64, set_v.clone(), token.get().clone().p_line_get(), ((token.get().clone().p_pos_get()).wrapping_add(modifierLen)).wrapping_add(1i64))?, crate::php_parser::Token::new(ord(&Str::from_static(")")), Str::from_static(")"), token.get().clone().p_line_get(), ((token.get().clone().p_pos_get()).wrapping_add(modifierLen)).wrapping_add(4i64))?); List::from_vec(vec![cast::<Mixed>(__c21.0), cast::<Mixed>(__c21.1), cast::<Mixed>(__c21.2), cast::<Mixed>(__c21.3)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
...
impl AttributeEmulator {
    ...
    let mut token: Late<crate::php_parser::Token> = Late::uninit();
    {
        ...
        'l1: loop {
            ...
            'c2: {
                token.set(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&i)).clone());
                if ((identical(&token.get().clone().p_text_get(), &Str::from_static("#")) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v))).and_then(|__b| __b.get(&__k).cloned()) }.is_some())) && identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), &Str::from_static("["))) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c22 = (crate::php_parser::Token::new(355i64, Str::from_static("#["), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c22.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
    ...
    pos = 0i64;
    'l1: loop {
        if !(!(cast::<i64>(false) == { let __t2 = strpos(&code.clone(), &Str::from_static("#["), pos).unwrap(); pos = __t2.clone(); __t2 })) { break; }
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if (((((token.get().clone().p_id_get() == 260i64) && identical(&token.get().clone().p_text_get(), &Str::from_static("0"))) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v))).and_then(|__b| __b.get(&__k).cloned()) }.is_some())) && (tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_id_get() == 262i64)) && truthy(&preg_match(&Str::from_static("/[oO][0-7]+(?:_[0-7]+)*/"), &tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), 0)?)) {
                    ...
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c23 = (crate::php_parser::Token::new(tokenKind, concat(Str::from_static("0"), tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get()), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c23.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
                    let _ = { let __t1 = c; c = __t1.wrapping_sub(1); __t1 };
                }
            }
            let _ = { let __t2 = i; i = __t2.wrapping_add(1); __t2.wrapping_add(1) };
...
impl NullsafeTokenEmulator {
    ...
    let mut matchLen: i64 = Default::default();
    {
        ...
        'l1: loop {
            ...
            'c2: {
                token.set(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&i)).clone());
                if ((identical(&token.get().clone().p_text_get(), &Str::from_static("?")) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v))).and_then(|__b| __b.get(&__k).cloned()) }.is_some())) && (tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_id_get() == 389i64)) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c24 = (crate::php_parser::Token::new(390i64, Str::from_static("?->"), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c24.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
                    let _ = { let __t1 = c; c = __t1.wrapping_sub(1); __t1 };
                    { break 'c2 };
                }
    ...
    let mut token: Late<crate::php_parser::Token> = Late::uninit();
    {
        ...
        'l1: loop {
            ...
            'c2: {
                token.set(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&i)).clone());
                if ((identical(&token.get().clone().p_text_get(), &Str::from_static("|")) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v))).and_then(|__b| __b.get(&__k).cloned()) }.is_some())) && identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), &Str::from_static(">"))) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c25 = (crate::php_parser::Token::new(408i64, Str::from_static("|>"), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c25.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
                    let _ = { let __t1 = c; c = __t1.wrapping_sub(1); __t1 };
                }
            }
            let _ = { let __t2 = i; i = __t2.wrapping_add(1); __t2.wrapping_add(1) };
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if (token.get().clone().p_id_get() == 408i64) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(1i64); let __repl = { let __c26 = (crate::php_parser::Token::new(ord(&Str::from_static("|")), Str::from_static("|"), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?, crate::php_parser::Token::new(ord(&Str::from_static(">")), Str::from_static(">"), token.get().clone().p_line_get(), (token.get().clone().p_pos_get()).wrapping_add(1i64))?); List::from_vec(vec![cast::<Mixed>(__c26.0), cast::<Mixed>(__c26.1)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if (((j < c) && (tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&j)).clone().p_id_get() == 397i64)) && truthy(&preg_match(&Str::from_static("/[ \\t]+/"), &tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&j)).clone().p_text_get(), 0)?)) {
                    append(&mut text, tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&j)).clone().p_text_get());
                    let _ = { let __t1 = numTokens; numTokens = __t1.wrapping_add(1); __t1 };
                ...
                append(&mut text, tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&j)).clone().p_text_get());
                let _ = { let __t3 = numTokens; numTokens = __t3.wrapping_add(1); __t3 };
                ...
                if (((k < c) && (tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&k)).clone().p_id_get() == 397i64)) && truthy(&preg_match(&Str::from_static("/[ \\t]+/"), &tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&k)).clone().p_text_get(), 0)?)) {
                    append(&mut text, tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&k)).clone().p_text_get());
                    let _ = { let __t4 = numTokens; numTokens = __t4.wrapping_add(1); __t4 };
                    let _ = { let __t5 = k; k = __t5.wrapping_add(1); __t5 };
                }
                if ((k >= c) || (!identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&k)).clone().p_text_get(), &Str::from_static(")")))) {
                    { break 'c2 };
                }
                append(&mut text, Str::from_static(")"));
                let _ = { let __t6 = numTokens; numTokens = __t6.wrapping_add(1); __t6 };
                let _: List<Mixed> = { let __off = i; let __len = Some(numTokens); let __repl = { let __c27 = (crate::php_parser::Token::new(388i64, text.clone(), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c27.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
                { let __t7 = (numTokens).wrapping_sub(1i64); c = (c).wrapping_sub(__t7); }
            }
            let _ = { let __t8 = i; i = __t8.wrapping_add(1); __t8.wrapping_add(1) };
        }
    }
    return Ok(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).map_values(|v| cast::<Mixed>(v)));
    }
