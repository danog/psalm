...
impl AsymmetricVisibilityTokenEmulator {
    ...
    map_v = Shape_326_Int_325_Int_324_Int { k326: 329i64, k325: 328i64, k324: 327i64 };
    {
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if ((((((({ let __k = to_key(&token.get().clone().p_id_get()); Some(map_v.clone()).and_then(|__b| { let __c19 = __b; let mut __m: Map<ArrayKey, i64> = Default::default(); __m.insert(ArrayKey::from(Str::from_static("326")), __c19.k326); __m.insert(ArrayKey::from(Str::from_static("325")), __c19.k325); __m.insert(ArrayKey::from(Str::from_static("324")), __c19.k324); __m }.get(&__k).cloned()) }.is_some()) && ((i).wrapping_add(3i64) < c)) && identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), &Str::from_static("("))) && (tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(2i64))).clone().p_id_get() == 262i64)) && identical(&strtolower(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(2i64))).clone().p_text_get()), &Str::from_static("set"))) && identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(3i64))).clone().p_text_get(), &Str::from_static(")"))) && self.isKeywordContext(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)), i)?) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(4i64); let __repl = { let __c21 = (crate::php_parser::Token::new({ let __c20 = map_v.clone(); let mut __m: Map<ArrayKey, i64> = Default::default(); __m.insert(ArrayKey::from(Str::from_static("326")), __c20.k326); __m.insert(ArrayKey::from(Str::from_static("325")), __c20.k325); __m.insert(ArrayKey::from(Str::from_static("324")), __c20.k324); __m }.idx(&to_key(&token.get().clone().p_id_get())).clone(), concat(concat(concat(token.get().clone().p_text_get(), Str::from_static("(")), tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(2i64))).clone().p_text_get()), Str::from_static(")")), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c21.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
    ...
    reverseMap = Shape_329_Int_328_Int_327_Int { k329: 326i64, k328: 325i64, k327: 324i64 };
    {
        ...
        'l1: loop {
            ...
            'c2: {
                token.set(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&i)).clone());
                if (({ let __k = to_key(&token.get().clone().p_id_get()); Some(reverseMap.clone()).and_then(|__b| { let __c22 = __b; let mut __m: Map<ArrayKey, i64> = Default::default(); __m.insert(ArrayKey::from(Str::from_static("329")), __c22.k329); __m.insert(ArrayKey::from(Str::from_static("328")), __c22.k328); __m.insert(ArrayKey::from(Str::from_static("327")), __c22.k327); __m }.get(&__k).cloned()) }.is_some()) && truthy(&{ let (__r, __m) = preg_match_groups(&Str::from_static("/(public|protected|private)\\((set)\\)/i"), &token.get().clone().p_text_get(), 0)?; matches = __m; __r })) {
                    ...
                    let _: List<Mixed> = { let __off = i; let __len = Some(1i64); let __repl = { let __c24 = (crate::php_parser::Token::new({ let __c23 = reverseMap.clone(); let mut __m: Map<ArrayKey, i64> = Default::default(); __m.insert(ArrayKey::from(Str::from_static("329")), __c23.k329); __m.insert(ArrayKey::from(Str::from_static("328")), __c23.k328); __m.insert(ArrayKey::from(Str::from_static("327")), __c23.k327); __m }.idx(&to_key(&token.get().clone().p_id_get())).clone(), modifier.clone(), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?, crate::php_parser::Token::new(ord(&Str::from_static("(")), Str::from_static("("), token.get().clone().p_line_get(), (token.get().clone().p_pos_get()).wrapping_add(modifierLen))?, crate::php_parser::Token::new(262i64, set_v.clone(), token.get().clone().p_line_get(), ((token.get().clone().p_pos_get()).wrapping_add(modifierLen)).wrapping_add(1i64))?, crate::php_parser::Token::new(ord(&Str::from_static(")")), Str::from_static(")"), token.get().clone().p_line_get(), ((token.get().clone().p_pos_get()).wrapping_add(modifierLen)).wrapping_add(4i64))?); List::from_vec(vec![cast::<Mixed>(__c24.0), cast::<Mixed>(__c24.1), cast::<Mixed>(__c24.2), cast::<Mixed>(__c24.3)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if ((identical(&token.get().clone().p_text_get(), &Str::from_static("#")) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone()).and_then(|__b| __b.get(&__k).cloned()) }.and_then(|__m| __m.to_option()).is_some())) && identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), &Str::from_static("["))) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c25 = (crate::php_parser::Token::new(355i64, Str::from_static("#["), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c25.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if (((((token.get().clone().p_id_get() == 260i64) && identical(&token.get().clone().p_text_get(), &Str::from_static("0"))) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone()).and_then(|__b| __b.get(&__k).cloned()) }.and_then(|__m| __m.to_option()).is_some())) && (tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_id_get() == 262i64)) && truthy(&preg_match(&Str::from_static("/[oO][0-7]+(?:_[0-7]+)*/"), &tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), 0)?)) {
                    ...
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c26 = (crate::php_parser::Token::new(tokenKind, concat(Str::from_static("0"), tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get()), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c26.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
                    let _ = { let __t1 = c; c = __t1.wrapping_sub(1); __t1 };
                }
            }
            let _ = { let __t2 = i; i = __t2.wrapping_add(1); __t2.wrapping_add(1) };
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if ((identical(&token.get().clone().p_text_get(), &Str::from_static("?")) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone()).and_then(|__b| __b.get(&__k).cloned()) }.and_then(|__m| __m.to_option()).is_some())) && (tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_id_get() == 389i64)) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c27 = (crate::php_parser::Token::new(390i64, Str::from_static("?->"), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c27.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
                    let _ = { let __t1 = c; c = __t1.wrapping_sub(1); __t1 };
                    { break 'c2 };
                }
    ...
    let mut token: Late<crate::php_parser::Token> = Late::uninit();
    {
        ...
        'l1: loop {
            ...
            'c2: {
                token.set(tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&i)).clone());
                if ((identical(&token.get().clone().p_text_get(), &Str::from_static("|")) && ({ let __k = to_key(&(i).wrapping_add(1i64)); Some(tokens_v.clone()).and_then(|__b| __b.get(&__k).cloned()) }.and_then(|__m| __m.to_option()).is_some())) && identical(&tokens_v.clone().map_values(|v| cast::<crate::php_parser::Token>(v)).idx(&to_key(&(i).wrapping_add(1i64))).clone().p_text_get(), &Str::from_static(">"))) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(2i64); let __repl = { let __c28 = (crate::php_parser::Token::new(408i64, Str::from_static("|>"), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c28.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
                    let _ = { let __t1 = c; c = __t1.wrapping_sub(1); __t1 };
                }
            }
            let _ = { let __t2 = i; i = __t2.wrapping_add(1); __t2.wrapping_add(1) };
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                if (token.get().clone().p_id_get() == 408i64) {
                    let _: List<Mixed> = { let __off = i; let __len = Some(1i64); let __repl = { let __c29 = (crate::php_parser::Token::new(ord(&Str::from_static("|")), Str::from_static("|"), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?, crate::php_parser::Token::new(ord(&Str::from_static(">")), Str::from_static(">"), token.get().clone().p_line_get(), (token.get().clone().p_pos_get()).wrapping_add(1i64))?); List::from_vec(vec![cast::<Mixed>(__c29.0), cast::<Mixed>(__c29.1)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
...
impl php_rt::PhpObject for ReverseEmulator {
    ...
    fn get_prop(&self, name: &str) -> Option<Mixed> { match name { "emulator" => self.p_emulator_opt().map(|v| cast::<Mixed>(v)), _ => None } }
...
impl php_rt::PhpObject for TokenEmulator {
    fn class_name(&self) -> &'static str { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => __h.class_name(), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => __h.class_name(), TokenEmulator::Other__(__m) => php_rt::other_obj(__m).class_name(), _ => unreachable!() } }
    fn class_ancestors(&self) -> &'static [&'static str] { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => __h.class_ancestors(), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => __h.class_ancestors(), TokenEmulator::Other__(__m) => php_rt::other_obj(__m).class_ancestors(), _ => unreachable!() } }
    fn obj_id(&self) -> usize { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => __h.obj_id(), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => __h.obj_id(), TokenEmulator::Other__(__m) => php_rt::other_obj(__m).obj_id(), _ => unreachable!() } }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => __h.props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => __h.props(), TokenEmulator::Other__(__m) => php_rt::other_obj(__m).props(), _ => unreachable!() } }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => __h.set_prop(name, value), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => __h.set_prop(name, value), TokenEmulator::Other__(__m) => php_rt::other_obj(__m).set_prop(name, value), _ => unreachable!() } }
    fn get_prop(&self, name: &str) -> Option<Mixed> { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => __h.get_prop(name), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => __h.get_prop(name), TokenEmulator::Other__(__m) => php_rt::other_obj(__m).get_prop(name), _ => unreachable!() } }
    fn php_to_string(&self) -> Option<Str> { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => __h.php_to_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => __h.php_to_string(), TokenEmulator::Other__(__m) => php_rt::other_obj(__m).php_to_string(), _ => unreachable!() } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => __h.call_method(name, args), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => __h.call_method(name, args), TokenEmulator::Other__(__m) => php_rt::other_obj(__m).call_method(name, args), _ => unreachable!() } }
    fn public_props(&self) -> Vec<(Str, Mixed)> { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => __h.public_props(), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => __h.public_props(), TokenEmulator::Other__(__m) => php_rt::other_obj(__m).public_props(), _ => unreachable!() } }
}
impl TokenEmulator { pub fn to_php_string(&self) -> Result<Str, Throw> { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => __h.to_php_string(), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => __h.to_php_string(), TokenEmulator::Other__(__m) => Ok(to_str(__m)), _ => unreachable!() } } }
impl php_rt::PhpClone for TokenEmulator { fn php_clone(&self) -> Self { match self { TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_AsymmetricVisibilityTokenEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_AttributeEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_EnumTokenEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_ExplicitOctalEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_FnTokenEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_MatchTokenEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_NullsafeTokenEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_PipeOperatorEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_PropertyTokenEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyFunctionTokenEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_ReadonlyTokenEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_ReverseEmulator(__h.php_clone()), TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h) => TokenEmulator::PhpParser_Lexer_TokenEmulator_VoidCastEmulator(__h.php_clone()), TokenEmulator::Other__(__m) => TokenEmulator::Other__(__m.clone()), _ => unreachable!() } } }
impl TokenEmulator {
    ...
    let mut k: i64 = Default::default();
    {
        ...
        'l1: loop {
            ...
            'c2: {
                ...
                let _: List<Mixed> = { let __off = i; let __len = Some(numTokens); let __repl = { let __c30 = (crate::php_parser::Token::new(388i64, text.clone(), token.get().clone().p_line_get(), token.get().clone().p_pos_get())?,); List::from_vec(vec![cast::<Mixed>(__c30.0)]) }.into_vec(); let __r = array_splice_m(&mut tokens_v, __off, __len, __repl); __r };
...
impl php_rt::Truthy for KeywordEmulator { fn truthy(&self) -> bool { match self { KeywordEmulator::Other__(__m) => truthy(__m), _ => true } } }
impl php_rt::Identical for KeywordEmulator { fn identical(&self, o: &Self) -> bool { match (self, o) { (KeywordEmulator::Other__(a), KeywordEmulator::Other__(b)) => identical(a, b), (KeywordEmulator::Other__(_), _) | (_, KeywordEmulator::Other__(_)) => false, _ => self.obj_id() == o.obj_id() } } }
...
impl php_rt::InstanceOf<KeywordEmulator> for KeywordEmulator { fn is_instance(&self) -> bool { match self { KeywordEmulator::Other__(__m) => __m.instance_of("phpparser\\lexer\\tokenemulator\\keywordemulator"), _ => true } } }
...
impl php_rt::Truthy for TokenEmulator { fn truthy(&self) -> bool { match self { TokenEmulator::Other__(__m) => truthy(__m), _ => true } } }
impl php_rt::Identical for TokenEmulator { fn identical(&self, o: &Self) -> bool { match (self, o) { (TokenEmulator::Other__(a), TokenEmulator::Other__(b)) => identical(a, b), (TokenEmulator::Other__(_), _) | (_, TokenEmulator::Other__(_)) => false, _ => self.obj_id() == o.obj_id() } } }
...
impl php_rt::InstanceOf<TokenEmulator> for TokenEmulator { fn is_instance(&self) -> bool { match self { TokenEmulator::Other__(__m) => __m.instance_of("phpparser\\lexer\\tokenemulator\\tokenemulator"), _ => true } } }
