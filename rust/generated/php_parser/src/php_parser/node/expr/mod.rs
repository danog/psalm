...
pub struct ArrayDimFetchObj {
    ...
    pub dim: Late<Option<crate::php_parser::node::Expr>>,
}
#[derive(Clone)]
...
impl ArrayDimFetch {
    ...
    pub fn p_dim(&self) -> Ref<'_, Option<crate::php_parser::node::Expr>> { Ref::map(self.0.borrow(), |o| o.dim.get()) }
    pub fn p_dim_get(&self) -> Option<crate::php_parser::node::Expr> { self.0.borrow().dim.get().clone() }
    pub fn p_dim_opt(&self) -> Option<Option<crate::php_parser::node::Expr>> { self.0.borrow().dim.as_option().cloned() }
    pub fn p_dim_mut(&self) -> RefMut<'_, Option<crate::php_parser::node::Expr>> { RefMut::map(self.0.borrow_mut(), |o| o.dim.get_or_default_mut()) }
    pub fn set_p_dim(&self, v: Option<crate::php_parser::node::Expr>) { self.0.borrow_mut().dim.set(v); }
    pub fn new_uninit() -> ArrayDimFetch {
        ArrayDimFetch(Rc::new(RefCell::new(ArrayDimFetchObj {
...
impl php_rt::PhpObject for ArrayDimFetch {
    ...
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } if let Some(v) = self.p_dim_opt() { out.push((Str::from_static("dim"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } if let Some(v) = self.p_dim_opt() { out.push((Str::from_static("dim"), cast::<Mixed>(v))); } out }
...
pub struct Array_Obj {
    pub attributes: Late<Map<Str, Mixed>>,
    pub items: Late<Map<i64, Option<crate::php_parser::node::ArrayItem>>>,
}
#[derive(Clone)]
...
impl Array_ {
    ...
    pub fn p_attributes_mut(&self) -> RefMut<'_, Map<Str, Mixed>> { RefMut::map(self.0.borrow_mut(), |o| o.attributes.get_or_default_mut()) }
    pub fn set_p_attributes(&self, v: Map<Str, Mixed>) { self.0.borrow_mut().attributes.set(v); }
    pub fn p_items(&self) -> Ref<'_, Map<i64, Option<crate::php_parser::node::ArrayItem>>> { Ref::map(self.0.borrow(), |o| o.items.get()) }
    pub fn p_items_get(&self) -> Map<i64, Option<crate::php_parser::node::ArrayItem>> { self.0.borrow().items.get().clone() }
    pub fn p_items_opt(&self) -> Option<Map<i64, Option<crate::php_parser::node::ArrayItem>>> { self.0.borrow().items.as_option().cloned() }
    pub fn p_items_mut(&self) -> RefMut<'_, Map<i64, Option<crate::php_parser::node::ArrayItem>>> { RefMut::map(self.0.borrow_mut(), |o| o.items.get_or_default_mut()) }
    pub fn set_p_items(&self, v: Map<i64, Option<crate::php_parser::node::ArrayItem>>) { self.0.borrow_mut().items.set(v); }
    pub fn new_uninit() -> Array_ {
        Array_(Rc::new(RefCell::new(Array_Obj {
            attributes: Late::uninit(),
            items: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for Array_ {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_items_opt() { out.push((Str::from_static("items"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_items_opt() { out.push((Str::from_static("items"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, crate::php_parser::node::ArrayItem>>(__a.clone()), None => <Map<ArrayKey, crate::php_parser::node::ArrayItem>>::default() }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Array_", name)))) } }
}
...
impl ArrowFunction {
    ...
    pub fn p_attributes_mut(&self) -> RefMut<'_, Map<Str, Mixed>> { RefMut::map(self.0.borrow_mut(), |o| o.attributes.get_or_default_mut()) }
    pub fn set_p_attributes(&self, v: Map<Str, Mixed>) { self.0.borrow_mut().attributes.set(v); }
    pub fn p_static_(&self) -> Ref<'_, bool> { Ref::map(self.0.borrow(), |o| o.static_.get()) }
    pub fn p_static__get(&self) -> bool { self.0.borrow().static_.get().clone() }
    pub fn p_static__opt(&self) -> Option<bool> { self.0.borrow().static_.as_option().cloned() }
    pub fn p_static__mut(&self) -> RefMut<'_, bool> { RefMut::map(self.0.borrow_mut(), |o| o.static_.get_or_default_mut()) }
    pub fn set_p_static_(&self, v: bool) { self.0.borrow_mut().static_.set(v); }
    ...
    pub fn new_uninit() -> ArrowFunction {
        ArrowFunction(Rc::new(RefCell::new(ArrowFunctionObj {
            attributes: Late::uninit(),
            static_: Late::uninit(),
            byRef: Late::uninit(),
    ...
    pub fn new(mut subNodes: Shape_expr_PhpParser_Node_Expr_static_q_Bool_byRefq_Bool_paramsq_Map_A_b76b7447f9, mut attributes: Map<Str, Mixed>) -> Result<ArrowFunction, Throw> {
    ...
    pub fn magic__construct(&self, mut subNodes: Shape_expr_PhpParser_Node_Expr_static_q_Bool_byRefq_Bool_paramsq_Map_A_b76b7447f9, mut attributes: Map<Str, Mixed>) -> Result<Mixed, Throw> {
    self.set_p_attributes(attributes.clone());
    self.set_p_static_((match Some(subNodes.clone()).and_then(|__b| __b.static_) { Some(__v) => __v, None => false }));
    self.set_p_byRef((match Some(subNodes.clone()).and_then(|__b| __b.byRef) { Some(__v) => __v, None => false }));
    self.set_p_params(cast::<List<crate::php_parser::node::Param>>((match Some(subNodes.clone()).and_then(|__b| __b.params) { Some(__v) => __v, None => Map::<ArrayKey, crate::php_parser::node::Param>::new() })));
    ...
    pub fn setAttributes(&self, mut attributes: Map<ArrayKey, Mixed>) -> Result<(), Throw> { cast::<crate::php_parser::NodeAbstract>(self.clone()).setAttributes__impl(attributes) }
    pub fn jsonSerialize(&self) -> Result<Map<Str, Mixed>, Throw> { cast::<crate::php_parser::NodeAbstract>(self.clone()).jsonSerialize__impl() }
    pub fn new_same_class(&self, mut subNodes: Shape_expr_PhpParser_Node_Expr_static_q_Bool_byRefq_Bool_paramsq_Map_A_b76b7447f9, mut attributes: Map<Str, Mixed>) -> Result<crate::php_parser::node::expr::ArrowFunction, Throw> { Ok(Self::new(subNodes, attributes)?) }
}
impl php_rt::PhpObject for ArrowFunction {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_static__opt() { out.push((Str::from_static("static"), cast::<Mixed>(v))); } if let Some(v) = self.p_byRef_opt() { out.push((Str::from_static("byRef"), cast::<Mixed>(v))); } if let Some(v) = Some(self.p_params_get()) { out.push((Str::from_static("params"), cast::<Mixed>(v))); } if let Some(v) = self.p_returnType_opt() { out.push((Str::from_static("returnType"), cast::<Mixed>(v))); } if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } if let Some(v) = self.p_attrGroups_opt() { out.push((Str::from_static("attrGroups"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_static__opt() { out.push((Str::from_static("static"), cast::<Mixed>(v))); } if let Some(v) = self.p_byRef_opt() { out.push((Str::from_static("byRef"), cast::<Mixed>(v))); } if let Some(v) = Some(self.p_params_get()) { out.push((Str::from_static("params"), cast::<Mixed>(v))); } if let Some(v) = self.p_returnType_opt() { out.push((Str::from_static("returnType"), cast::<Mixed>(v))); } if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } if let Some(v) = self.p_attrGroups_opt() { out.push((Str::from_static("attrGroups"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<Shape_expr_PhpParser_Node_Expr_static_q_Bool_byRefq_Bool_paramsq_Map_A_b76b7447f9>(__a.clone()), None => unreachable!("no default for Shape_expr_PhpParser_Node_Expr_static_q_Bool_byRefq_Bool_paramsq_Map_A_b76b7447f9") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "returnsbyref" => { let __r = self.returnsByRef().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getparams" => { let __r = self.getParams().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getreturntype" => { let __r = self.getReturnType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattrgroups" => { let __r = self.getAttrGroups().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstmts" => { let __r = self.getStmts().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\ArrowFunction", name)))) } }
}
...
impl Assign {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> Assign {
        Assign(Rc::new(RefCell::new(AssignObj {
            attributes: Late::uninit(),
            var: Late::uninit(),
            expr: Late::uninit(),
        })))
...
impl php_rt::PhpObject for Assign {
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(2) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Assign", name)))) } }
}
...
impl AssignRef {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> AssignRef {
        AssignRef(Rc::new(RefCell::new(AssignRefObj {
            attributes: Late::uninit(),
            var: Late::uninit(),
            expr: Late::uninit(),
        })))
...
impl php_rt::PhpObject for AssignRef {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "var" => { self.set_p_var(cast::<crate::php_parser::node::Expr>(value)); true }, "expr" => { self.set_p_expr(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(2) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\AssignRef", name)))) } }
}
...
impl BitwiseNot {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> BitwiseNot {
        BitwiseNot(Rc::new(RefCell::new(BitwiseNotObj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl BooleanNot {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> BooleanNot {
        BooleanNot(Rc::new(RefCell::new(BooleanNotObj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for BooleanNot {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "expr" => { self.set_p_expr(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\BooleanNot", name)))) } }
}
...
impl php_rt::PhpObject for CallLike {
    fn class_name(&self) -> &'static str { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.class_name(), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.class_name(), CallLike::PhpParser_Node_Expr_New_(__h) => __h.class_name(), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.class_name(), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.class_name(), CallLike::Other__(__m) => php_rt::other_obj(__m).class_name(), _ => unreachable!() } }
    fn class_ancestors(&self) -> &'static [&'static str] { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.class_ancestors(), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.class_ancestors(), CallLike::PhpParser_Node_Expr_New_(__h) => __h.class_ancestors(), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.class_ancestors(), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.class_ancestors(), CallLike::Other__(__m) => php_rt::other_obj(__m).class_ancestors(), _ => unreachable!() } }
    fn obj_id(&self) -> usize { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.obj_id(), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.obj_id(), CallLike::PhpParser_Node_Expr_New_(__h) => __h.obj_id(), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.obj_id(), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.obj_id(), CallLike::Other__(__m) => php_rt::other_obj(__m).obj_id(), _ => unreachable!() } }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.props(), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.props(), CallLike::PhpParser_Node_Expr_New_(__h) => __h.props(), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.props(), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.props(), CallLike::Other__(__m) => php_rt::other_obj(__m).props(), _ => unreachable!() } }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.set_prop(name, value), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.set_prop(name, value), CallLike::PhpParser_Node_Expr_New_(__h) => __h.set_prop(name, value), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.set_prop(name, value), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.set_prop(name, value), CallLike::Other__(__m) => php_rt::other_obj(__m).set_prop(name, value), _ => unreachable!() } }
    fn php_to_string(&self) -> Option<Str> { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.php_to_string(), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.php_to_string(), CallLike::PhpParser_Node_Expr_New_(__h) => __h.php_to_string(), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.php_to_string(), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.php_to_string(), CallLike::Other__(__m) => php_rt::other_obj(__m).php_to_string(), _ => unreachable!() } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.call_method(name, args), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.call_method(name, args), CallLike::PhpParser_Node_Expr_New_(__h) => __h.call_method(name, args), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.call_method(name, args), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.call_method(name, args), CallLike::Other__(__m) => php_rt::other_obj(__m).call_method(name, args), _ => unreachable!() } }
    fn public_props(&self) -> Vec<(Str, Mixed)> { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.public_props(), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.public_props(), CallLike::PhpParser_Node_Expr_New_(__h) => __h.public_props(), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.public_props(), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.public_props(), CallLike::Other__(__m) => php_rt::other_obj(__m).public_props(), _ => unreachable!() } }
}
impl CallLike { pub fn to_php_string(&self) -> Result<Str, Throw> { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.to_php_string(), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.to_php_string(), CallLike::PhpParser_Node_Expr_New_(__h) => __h.to_php_string(), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.to_php_string(), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.to_php_string(), CallLike::Other__(__m) => Ok(to_str(__m)), _ => unreachable!() } } }
impl php_rt::PhpClone for CallLike { fn php_clone(&self) -> Self { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => CallLike::PhpParser_Node_Expr_FuncCall(__h.php_clone()), CallLike::PhpParser_Node_Expr_MethodCall(__h) => CallLike::PhpParser_Node_Expr_MethodCall(__h.php_clone()), CallLike::PhpParser_Node_Expr_New_(__h) => CallLike::PhpParser_Node_Expr_New_(__h.php_clone()), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h.php_clone()), CallLike::PhpParser_Node_Expr_StaticCall(__h) => CallLike::PhpParser_Node_Expr_StaticCall(__h.php_clone()), CallLike::Other__(__m) => CallLike::Other__(__m.clone()), _ => unreachable!() } } }
impl CallLike {
    ...
    return Ok(((rawArgs.clone().count() == 1i64) && is_instance::<crate::php_parser::node::VariadicPlaceholder>(&rawArgs.clone().ptr_current().cloned().unwrap())));
    }
...
impl ClassConstFetch {
    ...
    pub fn new_uninit() -> ClassConstFetch {
        ClassConstFetch(Rc::new(RefCell::new(ClassConstFetchObj {
            attributes: Late::uninit(),
            class: Late::uninit(),
            name: Late::uninit(),
        })))
...
impl php_rt::PhpObject for ClassConstFetch {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_class_opt() { out.push((Str::from_static("class"), cast::<Mixed>(v))); } if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_class_opt() { out.push((Str::from_static("class"), cast::<Mixed>(v))); } if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Name>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Name") }), (match args.get(1) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Expr_Error_or_PhpParser_Node_Identifier_or_Str>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Expr_Error_or_PhpParser_Node_Identifier_or_Str") }), (match args.get(2) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\ClassConstFetch", name)))) } }
}
...
impl Clone_ {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> Clone_ {
        Clone_(Rc::new(RefCell::new(Clone_Obj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for Clone_ {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "expr" => { self.set_p_expr(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Clone_", name)))) } }
}
...
pub struct ClosureObj {
    ...
    pub static_: Late<bool>,
    pub byRef: Late<bool>,
    pub params: Late<List<crate::php_parser::node::Param>>,
    pub uses: Late<Map<ArrayKey, crate::php_parser::node::ClosureUse>>,
    pub returnType: Late<Option<U_PhpParser_Node_ComplexType_or_PhpParser_Node_Identifier_or_PhpParser_Node_Name>>,
...
impl Closure {
    ...
    pub fn p_byRef_mut(&self) -> RefMut<'_, bool> { RefMut::map(self.0.borrow_mut(), |o| o.byRef.get_or_default_mut()) }
    pub fn set_p_byRef(&self, v: bool) { self.0.borrow_mut().byRef.set(v); }
    pub fn p_params(&self) -> Ref<'_, List<crate::php_parser::node::Param>> { Ref::map(self.0.borrow(), |o| o.params.get()) }
    pub fn p_params_get(&self) -> List<crate::php_parser::node::Param> { self.0.borrow().params.get().clone() }
    pub fn p_params_opt(&self) -> Option<List<crate::php_parser::node::Param>> { self.0.borrow().params.as_option().cloned() }
    pub fn p_params_mut(&self) -> RefMut<'_, List<crate::php_parser::node::Param>> { RefMut::map(self.0.borrow_mut(), |o| o.params.get_or_default_mut()) }
    pub fn set_p_params(&self, v: List<crate::php_parser::node::Param>) { self.0.borrow_mut().params.set(v); }
    pub fn p_uses(&self) -> Ref<'_, Map<ArrayKey, crate::php_parser::node::ClosureUse>> { Ref::map(self.0.borrow(), |o| o.uses.get()) }
    pub fn p_uses_get(&self) -> Map<ArrayKey, crate::php_parser::node::ClosureUse> { self.0.borrow().uses.get().clone() }
    pub fn p_uses_opt(&self) -> Option<Map<ArrayKey, crate::php_parser::node::ClosureUse>> { self.0.borrow().uses.as_option().cloned() }
    pub fn p_uses_mut(&self) -> RefMut<'_, Map<ArrayKey, crate::php_parser::node::ClosureUse>> { RefMut::map(self.0.borrow_mut(), |o| o.uses.get_or_default_mut()) }
    pub fn set_p_uses(&self, v: Map<ArrayKey, crate::php_parser::node::ClosureUse>) { self.0.borrow_mut().uses.set(v); }
    pub fn p_returnType(&self) -> Ref<'_, Option<U_PhpParser_Node_ComplexType_or_PhpParser_Node_Identifier_or_PhpParser_Node_Name>> { Ref::map(self.0.borrow(), |o| o.returnType.get()) }
    pub fn p_returnType_get(&self) -> Option<U_PhpParser_Node_ComplexType_or_PhpParser_Node_Identifier_or_PhpParser_Node_Name> { self.0.borrow().returnType.get().clone() }
    pub fn p_returnType_opt(&self) -> Option<Option<U_PhpParser_Node_ComplexType_or_PhpParser_Node_Identifier_or_PhpParser_Node_Name>> { self.0.borrow().returnType.as_option().cloned() }
    pub fn p_returnType_mut(&self) -> RefMut<'_, Option<U_PhpParser_Node_ComplexType_or_PhpParser_Node_Identifier_or_PhpParser_Node_Name>> { RefMut::map(self.0.borrow_mut(), |o| o.returnType.get_or_default_mut()) }
    ...
    pub fn p_attrGroups_mut(&self) -> RefMut<'_, Map<ArrayKey, crate::php_parser::node::AttributeGroup>> { RefMut::map(self.0.borrow_mut(), |o| o.attrGroups.get_or_default_mut()) }
    pub fn set_p_attrGroups(&self, v: Map<ArrayKey, crate::php_parser::node::AttributeGroup>) { self.0.borrow_mut().attrGroups.set(v); }
    pub fn new_uninit() -> Closure {
        Closure(Rc::new(RefCell::new(ClosureObj {
            attributes: Late::uninit(),
            static_: Late::uninit(),
            byRef: Late::uninit(),
            params: Late::uninit(),
    ...
    pub fn new(mut subNodes: Shape_static_q_Bool_byRefq_Bool_paramsq_Map_ArrayKey_PhpParser_Node_Pa_cd3397f4bd, mut attributes: Map<Str, Mixed>) -> Result<Closure, Throw> {
    ...
    pub fn magic__construct(&self, mut subNodes: Shape_static_q_Bool_byRefq_Bool_paramsq_Map_ArrayKey_PhpParser_Node_Pa_cd3397f4bd, mut attributes: Map<Str, Mixed>) -> Result<Mixed, Throw> {
    self.set_p_attributes(attributes.clone());
    self.set_p_static_((match Some(subNodes.clone()).and_then(|__b| __b.static_) { Some(__v) => __v, None => false }));
    self.set_p_byRef((match Some(subNodes.clone()).and_then(|__b| __b.byRef) { Some(__v) => __v, None => false }));
    self.set_p_params(cast::<List<crate::php_parser::node::Param>>((match Some(subNodes.clone()).and_then(|__b| __b.params) { Some(__v) => __v, None => Map::<ArrayKey, crate::php_parser::node::Param>::new() })));
    self.set_p_uses((match Some(subNodes.clone()).and_then(|__b| __b.uses) { Some(__v) => __v, None => Map::<ArrayKey, crate::php_parser::node::ClosureUse>::new() }));
    self.set_p_returnType((match Some(subNodes.clone()).and_then(|__b| __b.returnType).flatten() { Some(__v) => Some(__v), None => { let _ = (); None::<U_PhpParser_Node_ComplexType_or_PhpParser_Node_Identifier_or_PhpParser_Node_Name> } }));
    ...
    pub fn setAttributes(&self, mut attributes: Map<ArrayKey, Mixed>) -> Result<(), Throw> { cast::<crate::php_parser::NodeAbstract>(self.clone()).setAttributes__impl(attributes) }
    pub fn jsonSerialize(&self) -> Result<Map<Str, Mixed>, Throw> { cast::<crate::php_parser::NodeAbstract>(self.clone()).jsonSerialize__impl() }
    pub fn new_same_class(&self, mut subNodes: Shape_static_q_Bool_byRefq_Bool_paramsq_Map_ArrayKey_PhpParser_Node_Pa_cd3397f4bd, mut attributes: Map<Str, Mixed>) -> Result<crate::php_parser::node::expr::Closure, Throw> { Ok(Self::new(subNodes, attributes)?) }
}
impl php_rt::PhpObject for Closure {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_static__opt() { out.push((Str::from_static("static"), cast::<Mixed>(v))); } if let Some(v) = self.p_byRef_opt() { out.push((Str::from_static("byRef"), cast::<Mixed>(v))); } if let Some(v) = self.p_params_opt() { out.push((Str::from_static("params"), cast::<Mixed>(v))); } if let Some(v) = self.p_uses_opt() { out.push((Str::from_static("uses"), cast::<Mixed>(v))); } if let Some(v) = self.p_returnType_opt() { out.push((Str::from_static("returnType"), cast::<Mixed>(v))); } if let Some(v) = self.p_stmts_opt() { out.push((Str::from_static("stmts"), cast::<Mixed>(v))); } if let Some(v) = self.p_attrGroups_opt() { out.push((Str::from_static("attrGroups"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_static__opt() { out.push((Str::from_static("static"), cast::<Mixed>(v))); } if let Some(v) = self.p_byRef_opt() { out.push((Str::from_static("byRef"), cast::<Mixed>(v))); } if let Some(v) = self.p_params_opt() { out.push((Str::from_static("params"), cast::<Mixed>(v))); } if let Some(v) = self.p_uses_opt() { out.push((Str::from_static("uses"), cast::<Mixed>(v))); } if let Some(v) = self.p_returnType_opt() { out.push((Str::from_static("returnType"), cast::<Mixed>(v))); } if let Some(v) = self.p_stmts_opt() { out.push((Str::from_static("stmts"), cast::<Mixed>(v))); } if let Some(v) = self.p_attrGroups_opt() { out.push((Str::from_static("attrGroups"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<Shape_static_q_Bool_byRefq_Bool_paramsq_Map_ArrayKey_PhpParser_Node_Pa_cd3397f4bd>(__a.clone()), None => <Shape_static_q_Bool_byRefq_Bool_paramsq_Map_ArrayKey_PhpParser_Node_Pa_cd3397f4bd>::default() }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "returnsbyref" => { let __r = self.returnsByRef().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getparams" => { let __r = self.getParams().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getreturntype" => { let __r = self.getReturnType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getstmts" => { let __r = self.getStmts().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattrgroups" => { let __r = self.getAttrGroups().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Closure", name)))) } }
}
...
impl ConstFetch {
    ...
    pub fn new_uninit() -> ConstFetch {
        ConstFetch(Rc::new(RefCell::new(ConstFetchObj {
            attributes: Late::uninit(),
            name: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for ConstFetch {
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Name>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Name") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\ConstFetch", name)))) } }
}
...
impl Empty_ {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> Empty_ {
        Empty_(Rc::new(RefCell::new(Empty_Obj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for Empty_ {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "expr" => { self.set_p_expr(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Empty_", name)))) } }
}
...
impl Error {
    ...
    pub fn p_attributes_mut(&self) -> RefMut<'_, Map<Str, Mixed>> { RefMut::map(self.0.borrow_mut(), |o| o.attributes.get_or_default_mut()) }
    pub fn set_p_attributes(&self, v: Map<Str, Mixed>) { self.0.borrow_mut().attributes.set(v); }
    pub fn new_uninit() -> Error {
        Error(Rc::new(RefCell::new(ErrorObj {
            attributes: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for Error {
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Error", name)))) } }
}
...
impl ErrorSuppress {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> ErrorSuppress {
        ErrorSuppress(Rc::new(RefCell::new(ErrorSuppressObj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for ErrorSuppress {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "expr" => { self.set_p_expr(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\ErrorSuppress", name)))) } }
}
...
impl Eval_ {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> Eval_ {
        Eval_(Rc::new(RefCell::new(Eval_Obj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for Eval_ {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "expr" => { self.set_p_expr(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Eval_", name)))) } }
}
...
impl Exit_ {
    ...
    pub fn new_uninit() -> Exit_ {
        Exit_(Rc::new(RefCell::new(Exit_Obj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl FuncCall {
    ...
    pub fn new_uninit() -> FuncCall {
        FuncCall(Rc::new(RefCell::new(FuncCallObj {
            attributes: Late::uninit(),
            name: Late::uninit(),
            args: Late::uninit(),
        })))
...
impl php_rt::PhpObject for FuncCall {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } if let Some(v) = self.p_args_opt() { out.push((Str::from_static("args"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } if let Some(v) = self.p_args_opt() { out.push((Str::from_static("args"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Name>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Name") }), (match args.get(1) { Some(__a) => cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>(__a.clone()), None => <Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>::default() }), (match args.get(2) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getrawargs" => { let __r = self.getRawArgs().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "isfirstclasscallable" => { let __r = self.isFirstClassCallable().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getargs" => { let __r = self.getArgs().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getarg" => { let __r = self.getArg((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => cast::<i64>(__a.clone()), None => <i64>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\FuncCall", name)))) } }
}
...
impl Include_ {
    ...
    pub fn new_uninit() -> Include_ {
        Include_(Rc::new(RefCell::new(Include_Obj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
            type_: Late::uninit(),
        })))
...
impl php_rt::PhpObject for Include_ {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } if let Some(v) = self.p_type__opt() { out.push((Str::from_static("type"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } if let Some(v) = self.p_type__opt() { out.push((Str::from_static("type"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<i64>(__a.clone()), None => <i64>::default() }), (match args.get(2) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Include_", name)))) } }
}
...
impl Instanceof_ {
    ...
    pub fn p_class_mut(&self) -> RefMut<'_, U_PhpParser_Node_Expr_or_PhpParser_Node_Name> { RefMut::map(self.0.borrow_mut(), |o| o.class.get_mut()) }
    pub fn set_p_class(&self, v: U_PhpParser_Node_Expr_or_PhpParser_Node_Name) { self.0.borrow_mut().class.set(v); }
    pub fn new_uninit() -> Instanceof_ {
        Instanceof_(Rc::new(RefCell::new(Instanceof_Obj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
            class: Late::uninit(),
        })))
...
impl php_rt::PhpObject for Instanceof_ {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } if let Some(v) = self.p_class_opt() { out.push((Str::from_static("class"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } if let Some(v) = self.p_class_opt() { out.push((Str::from_static("class"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Name>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Name") }), (match args.get(2) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Instanceof_", name)))) } }
}
...
impl Isset_ {
    ...
    pub fn new_uninit() -> Isset_ {
        Isset_(Rc::new(RefCell::new(Isset_Obj {
            attributes: Late::uninit(),
            vars: Late::uninit(),
        })))
    }
...
impl List_ {
    ...
    pub fn p_items_mut(&self) -> RefMut<'_, Map<i64, Option<crate::php_parser::node::ArrayItem>>> { RefMut::map(self.0.borrow_mut(), |o| o.items.get_or_default_mut()) }
    pub fn set_p_items(&self, v: Map<i64, Option<crate::php_parser::node::ArrayItem>>) { self.0.borrow_mut().items.set(v); }
    pub fn new_uninit() -> List_ {
        List_(Rc::new(RefCell::new(List_Obj {
            attributes: Late::uninit(),
            items: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for List_ {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_items_opt() { out.push((Str::from_static("items"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "items" => { self.set_p_items(cast::<Map<i64, Option<crate::php_parser::node::ArrayItem>>>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Option<crate::php_parser::node::ArrayItem>>>(__a.clone()), None => <Map<ArrayKey, Option<crate::php_parser::node::ArrayItem>>>::default() }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\List_", name)))) } }
}
...
pub struct Match_Obj {
    ...
    pub arms: Late<Map<ArrayKey, crate::php_parser::node::MatchArm>>,
}
#[derive(Clone)]
...
impl Match_ {
    ...
    pub fn p_arms(&self) -> Ref<'_, Map<ArrayKey, crate::php_parser::node::MatchArm>> { Ref::map(self.0.borrow(), |o| o.arms.get()) }
    pub fn p_arms_get(&self) -> Map<ArrayKey, crate::php_parser::node::MatchArm> { self.0.borrow().arms.get().clone() }
    pub fn p_arms_opt(&self) -> Option<Map<ArrayKey, crate::php_parser::node::MatchArm>> { self.0.borrow().arms.as_option().cloned() }
    pub fn p_arms_mut(&self) -> RefMut<'_, Map<ArrayKey, crate::php_parser::node::MatchArm>> { RefMut::map(self.0.borrow_mut(), |o| o.arms.get_or_default_mut()) }
    pub fn set_p_arms(&self, v: Map<ArrayKey, crate::php_parser::node::MatchArm>) { self.0.borrow_mut().arms.set(v); }
    pub fn new_uninit() -> Match_ {
        Match_(Rc::new(RefCell::new(Match_Obj {
            attributes: Late::uninit(),
            cond: Late::uninit(),
            arms: Late::uninit(),
        })))
...
impl php_rt::PhpObject for Match_ {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_cond_opt() { out.push((Str::from_static("cond"), cast::<Mixed>(v))); } if let Some(v) = self.p_arms_opt() { out.push((Str::from_static("arms"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_cond_opt() { out.push((Str::from_static("cond"), cast::<Mixed>(v))); } if let Some(v) = self.p_arms_opt() { out.push((Str::from_static("arms"), cast::<Mixed>(v))); } out }
...
impl MethodCall {
    ...
    pub fn p_args_mut(&self) -> RefMut<'_, Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>> { RefMut::map(self.0.borrow_mut(), |o| o.args.get_or_default_mut()) }
    pub fn set_p_args(&self, v: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>) { self.0.borrow_mut().args.set(v); }
    pub fn new_uninit() -> MethodCall {
        MethodCall(Rc::new(RefCell::new(MethodCallObj {
            attributes: Late::uninit(),
            var: Late::uninit(),
            name: Late::uninit(),
            args: Late::uninit(),
...
impl php_rt::PhpObject for MethodCall {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } if let Some(v) = self.p_args_opt() { out.push((Str::from_static("args"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } if let Some(v) = self.p_args_opt() { out.push((Str::from_static("args"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str") }), (match args.get(2) { Some(__a) => cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>(__a.clone()), None => <Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>::default() }), (match args.get(3) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getrawargs" => { let __r = self.getRawArgs().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "isfirstclasscallable" => { let __r = self.isFirstClassCallable().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getargs" => { let __r = self.getArgs().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getarg" => { let __r = self.getArg((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => cast::<i64>(__a.clone()), None => <i64>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\MethodCall", name)))) } }
}
...
impl New_ {
    ...
    pub fn p_args_mut(&self) -> RefMut<'_, Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>> { RefMut::map(self.0.borrow_mut(), |o| o.args.get_or_default_mut()) }
    pub fn set_p_args(&self, v: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>) { self.0.borrow_mut().args.set(v); }
    pub fn new_uninit() -> New_ {
        New_(Rc::new(RefCell::new(New_Obj {
            attributes: Late::uninit(),
            class: Late::uninit(),
            args: Late::uninit(),
        })))
...
impl php_rt::PhpObject for New_ {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_class_opt() { out.push((Str::from_static("class"), cast::<Mixed>(v))); } if let Some(v) = self.p_args_opt() { out.push((Str::from_static("args"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_class_opt() { out.push((Str::from_static("class"), cast::<Mixed>(v))); } if let Some(v) = self.p_args_opt() { out.push((Str::from_static("args"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_") }), (match args.get(1) { Some(__a) => cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>(__a.clone()), None => <Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>::default() }), (match args.get(2) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getrawargs" => { let __r = self.getRawArgs().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "isfirstclasscallable" => { let __r = self.isFirstClassCallable().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getargs" => { let __r = self.getArgs().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getarg" => { let __r = self.getArg((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => cast::<i64>(__a.clone()), None => <i64>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\New_", name)))) } }
}
...
impl NullsafeMethodCall {
    ...
    pub fn p_args_mut(&self) -> RefMut<'_, Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>> { RefMut::map(self.0.borrow_mut(), |o| o.args.get_or_default_mut()) }
    pub fn set_p_args(&self, v: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>) { self.0.borrow_mut().args.set(v); }
    pub fn new_uninit() -> NullsafeMethodCall {
        NullsafeMethodCall(Rc::new(RefCell::new(NullsafeMethodCallObj {
            attributes: Late::uninit(),
            var: Late::uninit(),
            name: Late::uninit(),
            args: Late::uninit(),
...
impl php_rt::PhpObject for NullsafeMethodCall {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } if let Some(v) = self.p_args_opt() { out.push((Str::from_static("args"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "var" => { self.set_p_var(cast::<crate::php_parser::node::Expr>(value)); true }, "name" => { self.set_p_name(cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier>(value)); true }, "args" => { self.set_p_args(cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str") }), (match args.get(2) { Some(__a) => cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>(__a.clone()), None => <Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>::default() }), (match args.get(3) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getrawargs" => { let __r = self.getRawArgs().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "isfirstclasscallable" => { let __r = self.isFirstClassCallable().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getargs" => { let __r = self.getArgs().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getarg" => { let __r = self.getArg((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => cast::<i64>(__a.clone()), None => <i64>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\NullsafeMethodCall", name)))) } }
}
...
impl NullsafePropertyFetch {
    ...
    pub fn p_name_mut(&self) -> RefMut<'_, U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier> { RefMut::map(self.0.borrow_mut(), |o| o.name.get_mut()) }
    pub fn set_p_name(&self, v: U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier) { self.0.borrow_mut().name.set(v); }
    pub fn new_uninit() -> NullsafePropertyFetch {
        NullsafePropertyFetch(Rc::new(RefCell::new(NullsafePropertyFetchObj {
            attributes: Late::uninit(),
            var: Late::uninit(),
            name: Late::uninit(),
        })))
...
impl php_rt::PhpObject for NullsafePropertyFetch {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str") }), (match args.get(2) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\NullsafePropertyFetch", name)))) } }
}
...
impl PostDec {
    ...
    pub fn p_var_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.var.get_mut()) }
    pub fn set_p_var(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().var.set(v); }
    pub fn new_uninit() -> PostDec {
        PostDec(Rc::new(RefCell::new(PostDecObj {
            attributes: Late::uninit(),
            var: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for PostDec {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } out }
...
impl PostInc {
    ...
    pub fn p_var_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.var.get_mut()) }
    pub fn set_p_var(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().var.set(v); }
    pub fn new_uninit() -> PostInc {
        PostInc(Rc::new(RefCell::new(PostIncObj {
            attributes: Late::uninit(),
            var: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for PostInc {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "var" => { self.set_p_var(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\PostInc", name)))) } }
}
...
impl PreDec {
    ...
    pub fn p_var_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.var.get_mut()) }
    pub fn set_p_var(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().var.set(v); }
    pub fn new_uninit() -> PreDec {
        PreDec(Rc::new(RefCell::new(PreDecObj {
            attributes: Late::uninit(),
            var: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for PreDec {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "var" => { self.set_p_var(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\PreDec", name)))) } }
}
...
impl PreInc {
    ...
    pub fn p_var_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.var.get_mut()) }
    pub fn set_p_var(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().var.set(v); }
    pub fn new_uninit() -> PreInc {
        PreInc(Rc::new(RefCell::new(PreIncObj {
            attributes: Late::uninit(),
            var: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for PreInc {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_var_opt() { out.push((Str::from_static("var"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "var" => { self.set_p_var(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\PreInc", name)))) } }
}
...
impl Print_ {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> Print_ {
        Print_(Rc::new(RefCell::new(Print_Obj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for Print_ {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "expr" => { self.set_p_expr(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Print_", name)))) } }
}
...
impl PropertyFetch {
    ...
    pub fn p_name_mut(&self) -> RefMut<'_, U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier> { RefMut::map(self.0.borrow_mut(), |o| o.name.get_mut()) }
    pub fn set_p_name(&self, v: U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier) { self.0.borrow_mut().name.set(v); }
    pub fn new_uninit() -> PropertyFetch {
        PropertyFetch(Rc::new(RefCell::new(PropertyFetchObj {
            attributes: Late::uninit(),
            var: Late::uninit(),
            name: Late::uninit(),
        })))
...
pub struct ShellExecObj {
    pub attributes: Late<Map<Str, Mixed>>,
    pub parts: Late<List<crate::php_parser::node::Expr>>,
}
#[derive(Clone)]
...
impl ShellExec {
    ...
    pub fn p_attributes_mut(&self) -> RefMut<'_, Map<Str, Mixed>> { RefMut::map(self.0.borrow_mut(), |o| o.attributes.get_or_default_mut()) }
    pub fn set_p_attributes(&self, v: Map<Str, Mixed>) { self.0.borrow_mut().attributes.set(v); }
    pub fn p_parts(&self) -> Ref<'_, List<crate::php_parser::node::Expr>> { Ref::map(self.0.borrow(), |o| o.parts.get()) }
    pub fn p_parts_get(&self) -> List<crate::php_parser::node::Expr> { self.0.borrow().parts.get().clone() }
    pub fn p_parts_opt(&self) -> Option<List<crate::php_parser::node::Expr>> { self.0.borrow().parts.as_option().cloned() }
    pub fn p_parts_mut(&self) -> RefMut<'_, List<crate::php_parser::node::Expr>> { RefMut::map(self.0.borrow_mut(), |o| o.parts.get_or_default_mut()) }
    pub fn set_p_parts(&self, v: List<crate::php_parser::node::Expr>) { self.0.borrow_mut().parts.set(v); }
    pub fn new_uninit() -> ShellExec {
        ShellExec(Rc::new(RefCell::new(ShellExecObj {
            attributes: Late::uninit(),
            parts: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for ShellExec {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_parts_opt() { out.push((Str::from_static("parts"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_parts_opt() { out.push((Str::from_static("parts"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, U_PhpParser_Node_Expr_or_PhpParser_Node_InterpolatedStringPart>>(__a.clone()), None => <Map<ArrayKey, U_PhpParser_Node_Expr_or_PhpParser_Node_InterpolatedStringPart>>::default() }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\ShellExec", name)))) } }
}
...
impl StaticCall {
    ...
    pub fn p_args_mut(&self) -> RefMut<'_, Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>> { RefMut::map(self.0.borrow_mut(), |o| o.args.get_or_default_mut()) }
    pub fn set_p_args(&self, v: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>) { self.0.borrow_mut().args.set(v); }
    pub fn new_uninit() -> StaticCall {
        StaticCall(Rc::new(RefCell::new(StaticCallObj {
            attributes: Late::uninit(),
            class: Late::uninit(),
            name: Late::uninit(),
            args: Late::uninit(),
...
impl php_rt::PhpObject for StaticCall {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_class_opt() { out.push((Str::from_static("class"), cast::<Mixed>(v))); } if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } if let Some(v) = self.p_args_opt() { out.push((Str::from_static("args"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_class_opt() { out.push((Str::from_static("class"), cast::<Mixed>(v))); } if let Some(v) = self.p_name_opt() { out.push((Str::from_static("name"), cast::<Mixed>(v))); } if let Some(v) = self.p_args_opt() { out.push((Str::from_static("args"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Name>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Name") }), (match args.get(1) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str") }), (match args.get(2) { Some(__a) => cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>(__a.clone()), None => <Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>::default() }), (match args.get(3) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getrawargs" => { let __r = self.getRawArgs().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "isfirstclasscallable" => { let __r = self.isFirstClassCallable().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getargs" => { let __r = self.getArgs().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getarg" => { let __r = self.getArg((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => cast::<i64>(__a.clone()), None => <i64>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\StaticCall", name)))) } }
}
...
impl StaticPropertyFetch {
    ...
    pub fn new_uninit() -> StaticPropertyFetch {
        StaticPropertyFetch(Rc::new(RefCell::new(StaticPropertyFetchObj {
            attributes: Late::uninit(),
            class: Late::uninit(),
            name: Late::uninit(),
        })))
...
impl php_rt::PhpObject for StaticPropertyFetch {
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_Name>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_Name") }), (match args.get(1) { Some(__a) => cast::<U_PhpParser_Node_Expr_or_PhpParser_Node_VarLikeIdentifier_or_Str>(__a.clone()), None => unreachable!("no default for U_PhpParser_Node_Expr_or_PhpParser_Node_VarLikeIdentifier_or_Str") }), (match args.get(2) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\StaticPropertyFetch", name)))) } }
}
...
pub struct TernaryObj {
    pub attributes: Late<Map<Str, Mixed>>,
    pub cond: Late<crate::php_parser::node::Expr>,
    pub if_: Late<Option<crate::php_parser::node::Expr>>,
...
impl Ternary {
    ...
    pub fn p_cond_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.cond.get_mut()) }
    pub fn set_p_cond(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().cond.set(v); }
    pub fn p_if_(&self) -> Ref<'_, Option<crate::php_parser::node::Expr>> { Ref::map(self.0.borrow(), |o| o.if_.get()) }
    pub fn p_if__get(&self) -> Option<crate::php_parser::node::Expr> { self.0.borrow().if_.get().clone() }
    pub fn p_if__opt(&self) -> Option<Option<crate::php_parser::node::Expr>> { self.0.borrow().if_.as_option().cloned() }
    pub fn p_if__mut(&self) -> RefMut<'_, Option<crate::php_parser::node::Expr>> { RefMut::map(self.0.borrow_mut(), |o| o.if_.get_or_default_mut()) }
    pub fn set_p_if_(&self, v: Option<crate::php_parser::node::Expr>) { self.0.borrow_mut().if_.set(v); }
    ...
    pub fn new_uninit() -> Ternary {
        Ternary(Rc::new(RefCell::new(TernaryObj {
            attributes: Late::uninit(),
            cond: Late::uninit(),
            if_: Late::uninit(),
            else_: Late::uninit(),
...
impl php_rt::PhpObject for Ternary {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_cond_opt() { out.push((Str::from_static("cond"), cast::<Mixed>(v))); } if let Some(v) = self.p_if__opt() { out.push((Str::from_static("if"), cast::<Mixed>(v))); } if let Some(v) = self.p_else__opt() { out.push((Str::from_static("else"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_cond_opt() { out.push((Str::from_static("cond"), cast::<Mixed>(v))); } if let Some(v) = self.p_if__opt() { out.push((Str::from_static("if"), cast::<Mixed>(v))); } if let Some(v) = self.p_else__opt() { out.push((Str::from_static("else"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => __a.clone().to_option().map(|__m| cast::<crate::php_parser::node::Expr>(__m)), None => <Option<crate::php_parser::node::Expr>>::default() }), (match args.get(2) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(3) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Ternary", name)))) } }
}
...
impl Throw_ {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> Throw_ {
        Throw_(Rc::new(RefCell::new(Throw_Obj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for Throw_ {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "expr" => { self.set_p_expr(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Throw_", name)))) } }
}
...
impl UnaryMinus {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> UnaryMinus {
        UnaryMinus(Rc::new(RefCell::new(UnaryMinusObj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl UnaryPlus {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> UnaryPlus {
        UnaryPlus(Rc::new(RefCell::new(UnaryPlusObj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for UnaryPlus {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "expr" => { self.set_p_expr(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\UnaryPlus", name)))) } }
}
...
impl Variable {
    ...
    pub fn new_uninit() -> Variable {
        Variable(Rc::new(RefCell::new(VariableObj {
            attributes: Late::uninit(),
            name: Late::uninit(),
        })))
    }
...
impl YieldFrom {
    ...
    pub fn p_expr_mut(&self) -> RefMut<'_, crate::php_parser::node::Expr> { RefMut::map(self.0.borrow_mut(), |o| o.expr.get_mut()) }
    pub fn set_p_expr(&self, v: crate::php_parser::node::Expr) { self.0.borrow_mut().expr.set(v); }
    pub fn new_uninit() -> YieldFrom {
        YieldFrom(Rc::new(RefCell::new(YieldFromObj {
            attributes: Late::uninit(),
            expr: Late::uninit(),
        })))
    }
...
impl php_rt::PhpObject for YieldFrom {
    ...
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_expr_opt() { out.push((Str::from_static("expr"), cast::<Mixed>(v))); } out }
    fn set_prop(&self, name: &str, value: Mixed) -> bool { match name { "attributes" => { self.set_p_attributes(cast::<Map<Str, Mixed>>(value)); true }, "expr" => { self.set_p_expr(cast::<crate::php_parser::node::Expr>(value)); true }, _ => false } }
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => cast::<crate::php_parser::node::Expr>(__a.clone()), None => unreachable!("no default for crate::php_parser::node::Expr") }), (match args.get(1) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\YieldFrom", name)))) } }
}
...
pub struct Yield_Obj {
    pub attributes: Late<Map<Str, Mixed>>,
    pub key: Late<Option<crate::php_parser::node::Expr>>,
    pub value: Late<Option<crate::php_parser::node::Expr>>,
}
#[derive(Clone)]
...
impl Yield_ {
    ...
    pub fn p_attributes_mut(&self) -> RefMut<'_, Map<Str, Mixed>> { RefMut::map(self.0.borrow_mut(), |o| o.attributes.get_or_default_mut()) }
    pub fn set_p_attributes(&self, v: Map<Str, Mixed>) { self.0.borrow_mut().attributes.set(v); }
    pub fn p_key(&self) -> Ref<'_, Option<crate::php_parser::node::Expr>> { Ref::map(self.0.borrow(), |o| o.key.get()) }
    pub fn p_key_get(&self) -> Option<crate::php_parser::node::Expr> { self.0.borrow().key.get().clone() }
    pub fn p_key_opt(&self) -> Option<Option<crate::php_parser::node::Expr>> { self.0.borrow().key.as_option().cloned() }
    pub fn p_key_mut(&self) -> RefMut<'_, Option<crate::php_parser::node::Expr>> { RefMut::map(self.0.borrow_mut(), |o| o.key.get_or_default_mut()) }
    pub fn set_p_key(&self, v: Option<crate::php_parser::node::Expr>) { self.0.borrow_mut().key.set(v); }
    pub fn p_value(&self) -> Ref<'_, Option<crate::php_parser::node::Expr>> { Ref::map(self.0.borrow(), |o| o.value.get()) }
    pub fn p_value_get(&self) -> Option<crate::php_parser::node::Expr> { self.0.borrow().value.get().clone() }
    pub fn p_value_opt(&self) -> Option<Option<crate::php_parser::node::Expr>> { self.0.borrow().value.as_option().cloned() }
    pub fn p_value_mut(&self) -> RefMut<'_, Option<crate::php_parser::node::Expr>> { RefMut::map(self.0.borrow_mut(), |o| o.value.get_or_default_mut()) }
    pub fn set_p_value(&self, v: Option<crate::php_parser::node::Expr>) { self.0.borrow_mut().value.set(v); }
    pub fn new_uninit() -> Yield_ {
        Yield_(Rc::new(RefCell::new(Yield_Obj {
            attributes: Late::uninit(),
            key: Late::uninit(),
            value: Late::uninit(),
        })))
...
impl php_rt::PhpObject for Yield_ {
    ...
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
    fn props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_attributes_opt() { out.push((Str::from_static("attributes"), cast::<Mixed>(v))); } if let Some(v) = self.p_key_opt() { out.push((Str::from_static("key"), cast::<Mixed>(v))); } if let Some(v) = self.p_value_opt() { out.push((Str::from_static("value"), cast::<Mixed>(v))); } out }
    fn public_props(&self) -> Vec<(Str, Mixed)> { let mut out = Vec::new(); if let Some(v) = self.p_key_opt() { out.push((Str::from_static("key"), cast::<Mixed>(v))); } if let Some(v) = self.p_value_opt() { out.push((Str::from_static("value"), cast::<Mixed>(v))); } out }
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match name { "__construct" => { let __r = self.magic__construct((match args.get(0) { Some(__a) => __a.clone().to_option().map(|__m| cast::<crate::php_parser::node::Expr>(__m)), None => <Option<crate::php_parser::node::Expr>>::default() }), (match args.get(1) { Some(__a) => __a.clone().to_option().map(|__m| cast::<crate::php_parser::node::Expr>(__m)), None => <Option<crate::php_parser::node::Expr>>::default() }), (match args.get(2) { Some(__a) => cast::<Map<Str, Mixed>>(__a.clone()), None => <Map<Str, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getsubnodenames" => { let __r = self.getSubNodeNames().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "gettype" => { let __r = self.getType().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getline" => { let __r = self.getLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartline" => { let __r = self.getStartLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendline" => { let __r = self.getEndLine().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstarttokenpos" => { let __r = self.getStartTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendtokenpos" => { let __r = self.getEndTokenPos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getstartfilepos" => { let __r = self.getStartFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getendfilepos" => { let __r = self.getEndFilePos().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getcomments" => { let __r = self.getComments().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getdoccomment" => { let __r = self.getDocComment().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setdoccomment" => { let __r = self.setDocComment((match args.get(0) { Some(__a) => cast::<crate::php_parser::comment::Doc>(__a.clone()), None => unreachable!("no default for crate::php_parser::comment::Doc") })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "setattribute" => { let __r = self.setAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "hasattribute" => { let __r = self.hasAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "getattribute" => { let __r = self.getAttribute((match args.get(0) { Some(__a) => cast::<Str>(__a.clone()), None => <Str>::default() }), (match args.get(1) { Some(__a) => __a.clone(), None => <Mixed>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(__r) }, "getattributes" => { let __r = self.getAttributes().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, "setattributes" => { let __r = self.setAttributes((match args.get(0) { Some(__a) => cast::<Map<ArrayKey, Mixed>>(__a.clone()), None => <Map<ArrayKey, Mixed>>::default() })).map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok({ let _ = __r; Mixed::Null }) }, "jsonserialize" => { let __r = self.jsonSerialize().map_err(|e| DynError::Obj(cast::<Mixed>(e)))?; Ok(cast::<Mixed>(__r)) }, _ => Err(DynError::Rt(RtError::error(format!("Call to undefined method {}::{}()", "PhpParser\\Node\\Expr\\Yield_", name)))) } }
}
...
pub struct CallableLikeTestObj {
...
#[derive(Clone)]
pub struct CallableLikeTest(pub Rc<RefCell<CallableLikeTestObj>>);
impl CallableLikeTest {
    ...
    pub fn new_uninit() -> CallableLikeTest {
        CallableLikeTest(Rc::new(RefCell::new(CallableLikeTestObj {
    ...
    pub fn new(mut name: Str) -> Result<CallableLikeTest, Throw> {
        let this = CallableLikeTest(Rc::new(RefCell::new(CallableLikeTestObj {
            expectedException: { let _ = (); None::<Str> },
            expectedExceptionMessage: { let _ = (); None::<Str> },
            expectedExceptionMessageRegExp: { let _ = (); None::<Str> },
            expectedExceptionCode: { let _ = (); None::<i64> },
    ...
    pub fn testIsFirstClassCallable(&self, mut node: crate::php_parser::node::expr::CallLike, mut isFirstClassCallable: bool) -> Result<(), Throw> {
    { let _ = self; crate::phpunit::framework::Assert::assertSame(cast::<Mixed>(isFirstClassCallable), cast::<Mixed>(node.clone().isFirstClassCallable()?), Str::from_static(""))? };
    if (!isFirstClassCallable) {
        { let _ = self; crate::phpunit::framework::Assert::assertSame(cast::<Mixed>(node.clone().getRawArgs()?), cast::<Mixed>(node.clone().getArgs()?), Str::from_static(""))? };
    }
    #[allow(unreachable_code)] Ok(())
    }
    pub fn testGetArg(&self, mut node: crate::php_parser::node::expr::CallLike, mut expected: Option<crate::php_parser::node::Arg>) -> Result<(), Throw> {
    { let _ = self; crate::phpunit::framework::Assert::assertSame(cast::<Mixed>(expected.clone()), cast::<Mixed>(node.clone().getArg(Str::from_static("bar"), 1i64)?), Str::from_static(""))? };
    #[allow(unreachable_code)] Ok(())
    }
    pub fn provideTestIsFirstClassCallable() -> Result<((crate::php_parser::node::expr::FuncCall, bool), (crate::php_parser::node::expr::FuncCall, bool), (crate::php_parser::node::expr::MethodCall, bool), (crate::php_parser::node::expr::MethodCall, bool), (crate::php_parser::node::expr::StaticCall, bool), (crate::php_parser::node::expr::StaticCall, bool), (crate::php_parser::node::expr::New_, bool), (crate::php_parser::node::expr::NullsafeMethodCall, bool), (crate::php_parser::node::expr::New_, bool), (crate::php_parser::node::expr::NullsafeMethodCall, bool)), Throw> {
    let mut normalArgs: Late<(crate::php_parser::node::Arg,)> = Late::uninit();
    let mut callableArgs: Late<(crate::php_parser::node::VariadicPlaceholder,)> = Late::uninit();
    normalArgs.set((crate::php_parser::node::Arg::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::scalar::Int_::new(1i64, Map::<Str, Mixed>::new())?), false, false, Map::<Str, Mixed>::new(), { let _ = (); None::<crate::php_parser::node::Identifier> })?,));
    callableArgs.set((crate::php_parser::node::VariadicPlaceholder::new(Map::<Str, Mixed>::new())?,));
    return Ok(((crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1351 = normalArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(__c1351.0)]) }), Map::<Str, Mixed>::new())?, false), (crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1352 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1352.0)]) }), Map::<Str, Mixed>::new())?, true), (crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1353 = normalArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(__c1353.0)]) }), Map::<Str, Mixed>::new())?, false), (crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1354 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1354.0)]) }), Map::<Str, Mixed>::new())?, true), (crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1355 = normalArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(__c1355.0)]) }), Map::<Str, Mixed>::new())?, false), (crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1356 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1356.0)]) }), Map::<Str, Mixed>::new())?, true), (crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1357 = normalArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(__c1357.0)]) }), Map::<Str, Mixed>::new())?, false), (crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1358 = normalArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(__c1358.0)]) }), Map::<Str, Mixed>::new())?, false), (crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1359 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1359.0)]) }), Map::<Str, Mixed>::new())?, true), (crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1360 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1360.0)]) }), Map::<Str, Mixed>::new())?, true)));
    }
    pub fn provideTestGetArg() -> Result<List<U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858>, Throw> {
    let mut foo: Late<crate::php_parser::node::Arg> = Late::uninit();
    let mut namedFoo: Late<crate::php_parser::node::Arg> = Late::uninit();
    let mut bar: Late<crate::php_parser::node::Arg> = Late::uninit();
    let mut namedBar: Late<crate::php_parser::node::Arg> = Late::uninit();
    let mut unpack: Late<crate::php_parser::node::Arg> = Late::uninit();
    let mut callableArgs: Late<(crate::php_parser::node::VariadicPlaceholder,)> = Late::uninit();
    foo.set(crate::php_parser::node::Arg::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::scalar::Int_::new(1i64, Map::<Str, Mixed>::new())?), false, false, Map::<Str, Mixed>::new(), { let _ = (); None::<crate::php_parser::node::Identifier> })?);
    namedFoo.set(crate::php_parser::node::Arg::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::scalar::Int_::new(1i64, Map::<Str, Mixed>::new())?), false, false, Map::<Str, Mixed>::new(), Some(crate::php_parser::node::Identifier::new(Str::from_static("foo"), Map::<Str, Mixed>::new())?))?);
    bar.set(crate::php_parser::node::Arg::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::scalar::Int_::new(2i64, Map::<Str, Mixed>::new())?), false, false, Map::<Str, Mixed>::new(), { let _ = (); None::<crate::php_parser::node::Identifier> })?);
    namedBar.set(crate::php_parser::node::Arg::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::scalar::Int_::new(2i64, Map::<Str, Mixed>::new())?), false, false, Map::<Str, Mixed>::new(), Some(crate::php_parser::node::Identifier::new(Str::from_static("bar"), Map::<Str, Mixed>::new())?))?);
    unpack.set(crate::php_parser::node::Arg::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::scalar::Int_::new(3i64, Map::<Str, Mixed>::new())?), false, true, Map::<Str, Mixed>::new(), { let _ = (); None::<crate::php_parser::node::Identifier> })?);
    callableArgs.set((crate::php_parser::node::VariadicPlaceholder::new(Map::<Str, Mixed>::new())?,));
    return Ok(list![U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null((crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m1: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m1.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(foo.get().clone())); __m1 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null((crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m2: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m2.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m2 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_FuncCall_PhpParser_Node_Arg((crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m3: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m3.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(foo.get().clone())); __m3.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(bar.get().clone())); __m3 }, Map::<Str, Mixed>::new())?, bar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_FuncCall_PhpParser_Node_Arg((crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m4: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m4.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m4 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_FuncCall_PhpParser_Node_Arg((crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m5: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m5.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m5.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m5 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_FuncCall_PhpParser_Node_Arg((crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m6: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m6.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m6.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m6 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null((crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m7: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m7.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m7.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(unpack.get().clone())); __m7 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null((crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1361 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1361.0)]) }), Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_MethodCall_Opt_Null((crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m8: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m8.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(foo.get().clone())); __m8 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_MethodCall_Opt_Null((crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m9: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m9.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m9 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_MethodCall_PhpParser_Node_Arg((crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m10: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m10.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(foo.get().clone())); __m10.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(bar.get().clone())); __m10 }, Map::<Str, Mixed>::new())?, bar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_MethodCall_PhpParser_Node_Arg((crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m11: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m11.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m11 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_MethodCall_PhpParser_Node_Arg((crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m12: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m12.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m12.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m12 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_MethodCall_PhpParser_Node_Arg((crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m13: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m13.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m13.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m13 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_MethodCall_Opt_Null((crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m14: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m14.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m14.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(unpack.get().clone())); __m14 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_MethodCall_Opt_Null((crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1362 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1362.0)]) }), Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_StaticCall_Opt_Null((crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m15: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m15.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(foo.get().clone())); __m15 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_StaticCall_Opt_Null((crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m16: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m16.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m16 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_StaticCall_PhpParser_Node_Arg((crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m17: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m17.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(foo.get().clone())); __m17.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(bar.get().clone())); __m17 }, Map::<Str, Mixed>::new())?, bar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_StaticCall_PhpParser_Node_Arg((crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m18: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m18.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m18 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_StaticCall_PhpParser_Node_Arg((crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m19: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m19.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m19.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m19 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_StaticCall_PhpParser_Node_Arg((crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m20: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m20.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m20.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m20 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_StaticCall_Opt_Null((crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m21: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m21.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m21.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(unpack.get().clone())); __m21 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_StaticCall_Opt_Null((crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1363 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1363.0)]) }), Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_New__Opt_Null((crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m22: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m22.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(foo.get().clone())); __m22 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_New__Opt_Null((crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m23: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m23.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m23 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_New__PhpParser_Node_Arg((crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m24: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m24.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(foo.get().clone())); __m24.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(bar.get().clone())); __m24 }, Map::<Str, Mixed>::new())?, bar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_New__PhpParser_Node_Arg((crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m25: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m25.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m25 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_New__PhpParser_Node_Arg((crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m26: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m26.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m26.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m26 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_New__PhpParser_Node_Arg((crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m27: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m27.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m27.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m27 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_New__Opt_Null((crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), { let mut __m28: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m28.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m28.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(unpack.get().clone())); __m28 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_NullsafeMethodCall_Opt_Null((crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m29: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m29.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(foo.get().clone())); __m29 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_NullsafeMethodCall_Opt_Null((crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m30: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m30.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m30 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_NullsafeMethodCall_PhpParser_Node_Arg((crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m31: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m31.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(foo.get().clone())); __m31.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(bar.get().clone())); __m31 }, Map::<Str, Mixed>::new())?, bar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_NullsafeMethodCall_PhpParser_Node_Arg((crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m32: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m32.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m32 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_NullsafeMethodCall_PhpParser_Node_Arg((crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m33: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m33.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m33.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m33 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_NullsafeMethodCall_PhpParser_Node_Arg((crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m34: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m34.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedBar.get().clone())); __m34.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m34 }, Map::<Str, Mixed>::new())?, namedBar.get().clone())), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_NullsafeMethodCall_Opt_Null((crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), { let mut __m35: Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder> = Map::new(); __m35.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(namedFoo.get().clone())); __m35.push(U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(unpack.get().clone())); __m35 }, Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_New__Opt_Null((crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1364 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1364.0)]) }), Map::<Str, Mixed>::new())?, { let _ = (); None::<()> })), U_Tup2_PhpParser_Node_Expr_FuncCall_Opt_Null_or_Tup2_PhpParser_Node_Ex_5457cd2858::Tup2_PhpParser_Node_Expr_NullsafeMethodCall_Opt_Null((crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1365 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1365.0)]) }), Map::<Str, Mixed>::new())?, { let _ = (); None::<()> }))]);
    }
    ...
    pub fn new_same_class(&self, mut name: Str) -> Result<crate::php_parser::node::expr::CallableLikeTest, Throw> { Ok(Self::new(name)?) }
}
impl php_rt::PhpObject for CallableLikeTest {
    fn class_name(&self) -> &'static str { "PhpParser\\Node\\Expr\\CallableLikeTest" }
    fn class_ancestors(&self) -> &'static [&'static str] { &["phpparser\\node\\expr\\callableliketest", "phpunit\\framework\\testcase", "phpunit\\framework\\assert"] }
    fn obj_id(&self) -> usize { Rc::as_ptr(&self.0) as *const u8 as usize }
    fn as_any(&self) -> &dyn std::any::Any { self }
...
impl php_rt::Truthy for AssignOp { fn truthy(&self) -> bool { match self { AssignOp::Other__(__m) => truthy(__m), _ => true } } }
impl php_rt::Identical for AssignOp { fn identical(&self, o: &Self) -> bool { match (self, o) { (AssignOp::Other__(a), AssignOp::Other__(b)) => identical(a, b), (AssignOp::Other__(_), _) | (_, AssignOp::Other__(_)) => false, _ => self.obj_id() == o.obj_id() } } }
...
impl php_rt::InstanceOf<AssignOp> for AssignOp { fn is_instance(&self) -> bool { match self { AssignOp::Other__(__m) => __m.instance_of("phpparser\\node\\expr\\assignop"), _ => true } } }
...
impl php_rt::Truthy for BinaryOp { fn truthy(&self) -> bool { match self { BinaryOp::Other__(__m) => truthy(__m), _ => true } } }
impl php_rt::Identical for BinaryOp { fn identical(&self, o: &Self) -> bool { match (self, o) { (BinaryOp::Other__(a), BinaryOp::Other__(b)) => identical(a, b), (BinaryOp::Other__(_), _) | (_, BinaryOp::Other__(_)) => false, _ => self.obj_id() == o.obj_id() } } }
...
impl php_rt::InstanceOf<BinaryOp> for BinaryOp { fn is_instance(&self) -> bool { match self { BinaryOp::Other__(__m) => __m.instance_of("phpparser\\node\\expr\\binaryop"), _ => true } } }
...
impl php_rt::Truthy for CallLike { fn truthy(&self) -> bool { match self { CallLike::Other__(__m) => truthy(__m), _ => true } } }
impl php_rt::Identical for CallLike { fn identical(&self, o: &Self) -> bool { match (self, o) { (CallLike::Other__(a), CallLike::Other__(b)) => identical(a, b), (CallLike::Other__(_), _) | (_, CallLike::Other__(_)) => false, _ => self.obj_id() == o.obj_id() } } }
...
impl php_rt::CastTo<Mixed> for CallLike { fn cast_to(self) -> Mixed { match self { CallLike::PhpParser_Node_Expr_FuncCall(v) => Mixed::Obj(Rc::new(v)), CallLike::PhpParser_Node_Expr_MethodCall(v) => Mixed::Obj(Rc::new(v)), CallLike::PhpParser_Node_Expr_New_(v) => Mixed::Obj(Rc::new(v)), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(v) => Mixed::Obj(Rc::new(v)), CallLike::PhpParser_Node_Expr_StaticCall(v) => Mixed::Obj(Rc::new(v)), CallLike::Other__(m) => m, _ => unreachable!() } } }
impl php_rt::CastTo<CallLike> for Mixed { fn cast_to(self) -> CallLike { if let Mixed::Obj(o) = &self { if let Some(v) = o.as_any().downcast_ref::<crate::php_parser::node::expr::FuncCall>() { return crate::php_parser::node::expr::CallLike::PhpParser_Node_Expr_FuncCall(v.clone()); } if let Some(v) = o.as_any().downcast_ref::<crate::php_parser::node::expr::MethodCall>() { return crate::php_parser::node::expr::CallLike::PhpParser_Node_Expr_MethodCall(v.clone()); } if let Some(v) = o.as_any().downcast_ref::<crate::php_parser::node::expr::New_>() { return crate::php_parser::node::expr::CallLike::PhpParser_Node_Expr_New_(v.clone()); } if let Some(v) = o.as_any().downcast_ref::<crate::php_parser::node::expr::NullsafeMethodCall>() { return crate::php_parser::node::expr::CallLike::PhpParser_Node_Expr_NullsafeMethodCall(v.clone()); } if let Some(v) = o.as_any().downcast_ref::<crate::php_parser::node::expr::StaticCall>() { return crate::php_parser::node::expr::CallLike::PhpParser_Node_Expr_StaticCall(v.clone()); } } CallLike::Other__(self) } }
...
impl php_rt::InstanceOf<CallLike> for CallLike { fn is_instance(&self) -> bool { match self { CallLike::Other__(__m) => __m.instance_of("phpparser\\node\\expr\\calllike"), _ => true } } }
impl php_rt::Truthy for Cast { fn truthy(&self) -> bool { match self { Cast::Other__(__m) => truthy(__m), _ => true } } }
impl php_rt::Identical for Cast { fn identical(&self, o: &Self) -> bool { match (self, o) { (Cast::Other__(a), Cast::Other__(b)) => identical(a, b), (Cast::Other__(_), _) | (_, Cast::Other__(_)) => false, _ => self.obj_id() == o.obj_id() } } }
...
impl php_rt::InstanceOf<Cast> for Cast { fn is_instance(&self) -> bool { match self { Cast::Other__(__m) => __m.instance_of("phpparser\\node\\expr\\cast"), _ => true } } }
...
impl php_rt::Truthy for CallableLikeTest { fn truthy(&self) -> bool { true } }
impl php_rt::Identical for CallableLikeTest { fn identical(&self, o: &Self) -> bool { self.obj_id() == o.obj_id() } }
impl php_rt::ToStr for CallableLikeTest { fn to_php_str(&self) -> Str { self.php_to_string().unwrap_or_else(|| Str::from_static("PhpParser\\Node\\Expr\\CallableLikeTest")) } }
impl php_rt::PhpCmp for CallableLikeTest { fn php_cmp(&self, o: &Self) -> std::cmp::Ordering { cast::<Mixed>(self.clone()).php_cmp(&cast::<Mixed>(o.clone())) } }
impl std::fmt::Debug for CallableLikeTest { fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result { write!(f, "object({})#{}", self.class_name(), self.obj_id()) } }
impl php_rt::CastTo<Mixed> for CallableLikeTest { fn cast_to(self) -> Mixed { Mixed::Obj(Rc::new(self)) } }
impl php_rt::CastTo<CallableLikeTest> for Mixed { fn cast_to(self) -> CallableLikeTest { if let Mixed::Obj(o) = &self { if let Some(v) = o.as_any().downcast_ref::<crate::php_parser::node::expr::CallableLikeTest>() { return v.clone(); } } panic!("Mixed value is not a PhpParser\\Node\\Expr\\CallableLikeTest") } }
impl php_rt::TryDowncast for CallableLikeTest { fn try_downcast(o: &AnyObj) -> Option<Self> { if let Some(v) = o.as_any().downcast_ref::<crate::php_parser::node::expr::CallableLikeTest>() { return Some(v.clone()); } None } }
impl php_rt::CastTo<AnyObject> for CallableLikeTest { fn cast_to(self) -> AnyObject { AnyObject::from_mixed(cast::<Mixed>(self)) } }
impl php_rt::CastTo<CallableLikeTest> for AnyObject { fn cast_to(self) -> CallableLikeTest { cast::<CallableLikeTest>(cast::<Mixed>(self)) } }
impl php_rt::InstanceOf<CallableLikeTest> for AnyObject { fn is_instance(&self) -> bool { self.instance_of_name("phpparser\\node\\expr\\callableliketest") } }
impl php_rt::InstanceOf<CallableLikeTest> for Mixed { fn is_instance(&self) -> bool { self.instance_of("phpparser\\node\\expr\\callableliketest") } }
impl php_rt::InstanceOf<CallableLikeTest> for CallableLikeTest { fn is_instance(&self) -> bool { true } }
