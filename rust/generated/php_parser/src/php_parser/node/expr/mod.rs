...
impl php_rt::PhpObject for CallLike {
    ...
    fn call_method(&self, name: &str, args: Vec<Mixed>) -> Result<Mixed, DynError> { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.call_method(name, args), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.call_method(name, args), CallLike::PhpParser_Node_Expr_New_(__h) => __h.call_method(name, args), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.call_method(name, args), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.call_method(name, args), _ => unreachable!() } }
    fn public_props(&self) -> Vec<(Str, Mixed)> { match self { CallLike::PhpParser_Node_Expr_FuncCall(__h) => __h.public_props(), CallLike::PhpParser_Node_Expr_MethodCall(__h) => __h.public_props(), CallLike::PhpParser_Node_Expr_New_(__h) => __h.public_props(), CallLike::PhpParser_Node_Expr_NullsafeMethodCall(__h) => __h.public_props(), CallLike::PhpParser_Node_Expr_StaticCall(__h) => __h.public_props(), _ => unreachable!() } }
}
...
impl CallableLikeTest {
    ...
    return Ok(((crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1334 = normalArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(__c1334.0)]) }), Map::<Str, Mixed>::new())?, false), (crate::php_parser::node::expr::FuncCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("test")), Map::<Str, Mixed>::new())?), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1335 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1335.0)]) }), Map::<Str, Mixed>::new())?, true), (crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1336 = normalArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(__c1336.0)]) }), Map::<Str, Mixed>::new())?, false), (crate::php_parser::node::expr::MethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1337 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1337.0)]) }), Map::<Str, Mixed>::new())?, true), (crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1338 = normalArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(__c1338.0)]) }), Map::<Str, Mixed>::new())?, false), (crate::php_parser::node::expr::StaticCall::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1339 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1339.0)]) }), Map::<Str, Mixed>::new())?, true), (crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1340 = normalArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(__c1340.0)]) }), Map::<Str, Mixed>::new())?, false), (crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1341 = normalArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_Arg(__c1341.0)]) }), Map::<Str, Mixed>::new())?, false), (crate::php_parser::node::expr::New_::new(U_PhpParser_Node_Expr_or_PhpParser_Node_Name_or_PhpParser_Node_Stmt_Class_::PhpParser_Node_Name(crate::php_parser::node::Name::new(U_Map_ArrayKey_Str_or_PhpParser_Node_Name_or_Str::Str(Str::from_static("Test")), Map::<Str, Mixed>::new())?), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1342 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1342.0)]) }), Map::<Str, Mixed>::new())?, true), (crate::php_parser::node::expr::NullsafeMethodCall::new(cast::<crate::php_parser::node::Expr>(crate::php_parser::node::expr::Variable::new(U_PhpParser_Node_Expr_or_Str::Str(Str::from_static("this")), Map::<Str, Mixed>::new())?), U_PhpParser_Node_Expr_or_PhpParser_Node_Identifier_or_Str::Str(Str::from_static("test")), cast::<Map<ArrayKey, U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder>>({ let __c1343 = callableArgs.get().clone(); List::from_vec(vec![U_PhpParser_Node_Arg_or_PhpParser_Node_VariadicPlaceholder::PhpParser_Node_VariadicPlaceholder(__c1343.0)]) }), Map::<Str, Mixed>::new())?, true)));
    }
