...
class Parser
{
    ...
    // TypePHP: generators are FiberGenerator objects, not \Generator instances
     ...
     */
    public function __construct(object $generator)
    {
    ...
    {
        \assert($this->generator !== null, "Invalid parser state");
