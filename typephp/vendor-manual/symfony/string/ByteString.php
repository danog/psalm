    ...
    public function match(string $regexp, int $flags = 0, int $offset = 0): array
    {
        ...
        try {
            ...
            $result = 'preg_match_all' === $match
                ? preg_match_all($regexp, $this->string, $matches, $flags | \PREG_UNMATCHED_AS_NULL, $offset)
                : preg_match($regexp, $this->string, $matches, $flags | \PREG_UNMATCHED_AS_NULL, $offset);
            if (false === $result) {
