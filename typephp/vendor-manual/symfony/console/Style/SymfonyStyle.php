...
class SymfonyStyle extends OutputStyle
{
    ...
    // TypePHP: renamed, OutputStyle declares a private $output as well
    ...
    public function askQuestion(Question $question): mixed
    {
        ...
        if ($this->input->isInteractive()) {
            if ($this->styleOutput instanceof ConsoleSectionOutput) {
                ...
                $this->styleOutput->addNewLineOfInputSubmit();
    ...
    {
        $output = $this->styleOutput instanceof ConsoleOutputInterface ? $this->styleOutput->section() : $this->styleOutput;
