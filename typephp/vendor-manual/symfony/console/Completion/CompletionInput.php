...
final class CompletionInput extends ArgvInput
{
    ...
    private array $completionTokens;
    ...
    public function bind(InputDefinition $definition): void
    {
        ...
        $previousToken = $this->completionTokens[$this->currentIndex - 1];
        ...
        if ($this->currentIndex >= \count($this->completionTokens)) {
    ...
    {
        return $this->completionTokens[$this->isCursorFree() ? $this->currentIndex - 1 : $this->currentIndex];
    }
    ...
    {
        $nrOfTokens = \count($this->completionTokens);
    ...
    {
        $str = '';
        foreach ($this->completionTokens as $i => $token) {
            $str .= $token;
